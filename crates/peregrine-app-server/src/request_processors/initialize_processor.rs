...
const NON_ORIGINATING_CLIENT_NAMES: &[&str] = &["peregrine_app_server_daemon", "peregrine-backend"];
...
impl InitializeRequestProcessor {
    ...
    pub(crate) async fn initialize(
            ...
            if let Err(error) = set_default_originator(originator.clone()) {
                match error {
                    ...
                    SetOriginatorError::AlreadyInitialized => {
                        ...
                        // TODO(owen): Once we remove support for PEREGRINE_INTERNAL_ORIGINATOR_OVERRIDE,
        ...
        let _ = (connection_id, analytics_initialize_params, originator);
