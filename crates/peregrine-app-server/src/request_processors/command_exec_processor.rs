    ...
    async fn exec_one_off_command_inner(
        ...
        let (
            ...
            let file_system_sandbox_policy =
                peregrine_types::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy_for_cwd(&policy, &sandbox_cwd);
            let network_sandbox_policy =
                peregrine_types::permissions::NetworkSandboxPolicy::from(&policy);
            let permission_profile =
                peregrine_types::models::PermissionProfile::from_runtime_permissions_with_enforcement(
                    peregrine_types::models::SandboxEnforcement::from_legacy_sandbox_policy(&policy),
        ...
        let exec_params = ExecParams {
            ...
            network: started_network_proxy
                .as_ref()
                .map(peregrine_core::config::StartedNetworkProxy::proxy),
        ...
        let peregrine_linux_sandbox_exe = self.arg0_paths.codex_linux_sandbox_exe.clone();
        ...
        let exec_request = peregrine_core::exec::build_exec_request(
            exec_params,
            &effective_permission_profile,
            &sandbox_cwd,
