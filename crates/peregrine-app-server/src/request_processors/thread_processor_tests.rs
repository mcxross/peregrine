...
mod thread_processor_behavior_tests {
    async fn forked_from_id_from_rollout(path: &Path) -> Option<String> {
        peregrine_core::read_session_meta_line(path)
            .await
            .ok()
    ...
    fn validate_dynamic_tools_accepts_responses_compatible_identifiers() {
        let tools = vec![ApiDynamicToolSpec {
            namespace: Some("Peregrine-App_2".to_string()),
    ...
    fn validate_dynamic_tools_rejects_duplicate_name_in_same_namespace() {
        ...
        assert!(err.contains("peregrine_app"), "unexpected error: {err}");
        assert!(err.contains("my_tool"), "unexpected error: {err}");
    }
    ...
    fn summary_from_stored_thread_preserves_millisecond_precision() {
        ...
        let stored_thread = StoredThread {
            ...
            thread_source: Some(peregrine_types::protocol::ThreadSource::User),
            agent_nickname: None,
            agent_role: None,
            agent_path: None,
            git_info: None,
    ...
    fn requested_permissions_trust_project_uses_permission_profile_intent() {
        ...
        let full_access_profile = peregrine_types::models::PermissionProfile::Disabled;
        let workspace_write_profile = peregrine_types::models::PermissionProfile::workspace_write();
        let read_only_profile = peregrine_types::models::PermissionProfile::read_only();
        let split_write_profile =
            peregrine_types::models::PermissionProfile::from_runtime_permissions(
    ...
    fn collect_resume_override_mismatches_includes_service_tier() {
        ...
        let config_snapshot = ThreadConfigSnapshot {
            ...
            approval_policy: peregrine_types::protocol::AskForApproval::OnRequest,
            approvals_reviewer: peregrine_types::config_types::ApprovalsReviewer::User,
            permission_profile: peregrine_types::models::PermissionProfile::Disabled,
    ...
    fn test_thread_metadata(
        ...
        let mut builder = ThreadMetadataBuilder::new(
            ...
            Utc::now(),
            peregrine_types::protocol::SessionSource::default(),
        );
    ...
    fn merge_persisted_resume_metadata_prefers_persisted_model_and_reasoning_effort() -> Result<()>
    {
        ...
        let persisted_metadata =
            test_thread_metadata(Some("gpt-5.1-peregrine-max"), Some(ReasoningEffort::High))?;
        ...
        assert_eq!(
            ...
            Some("gpt-5.1-peregrine-max".to_string())
        );
        assert_eq!(
    ...
    async fn read_summary_from_rollout_preserves_agent_nickname() -> Result<()> {
        ...
        let session_meta = SessionMeta {
            ...
            thread_source: Some(peregrine_types::protocol::ThreadSource::Subagent),
    ...
    fn summary_from_state_db_metadata_preserves_agent_nickname() -> Result<()> {
        ...
        let summary = summary_from_state_db_metadata(
            ...
            "0.0.0".to_string(),
            source,
            Some(peregrine_types::protocol::ThreadSource::Subagent),
