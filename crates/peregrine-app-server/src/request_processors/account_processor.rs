...
const LOGIN_ISSUER_OVERRIDE_ENV_VAR: &str = "PEREGRINE_APP_SERVER_LOGIN_ISSUER";
...
impl AccountRequestProcessor {
    ...
    async fn login_v2(
        ...
        match params {
            ...
            LoginAccountParams::Chatgpt {
                peregrine_streamlined_login,
            } => {
                self.login_chatgpt_v2(request_id, peregrine_streamlined_login)
                    .await;
            }
    ...
    async fn login_api_key_common(
        ...
        match login_with_api_key(
            ...
            &params.api_key,
            peregrine_core::config::codex_auth_credentials_store_mode(
    ...
    async fn login_chatgpt_common(
        ...
        let opts = LoginServerOptions {
            open_browser: false,
            codex_streamlined_login: peregrine_streamlined_login,
    ...
    async fn login_chatgpt_v2(
        ...
        let result = self
            .login_chatgpt_response(peregrine_streamlined_login)
            .await;
        self.outgoing.send_result(request_id, result).await;
    }
    ...
    async fn login_chatgpt_response(
        ...
        let opts = self
            .login_chatgpt_common(peregrine_streamlined_login)
            .await?;
    ...
    async fn login_chatgpt_device_code_response(
        ...
        let opts = self
            .login_chatgpt_common(/*peregrine_streamlined_login*/ false)
            .await?;
