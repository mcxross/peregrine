...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: peregrine_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<peregrine_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<PeregrineThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<PeregrineThread>) -> bool {
...
mod tests {
    use super::*;
    use peregrine_app_server_protocol::ApprovalsReviewer;
