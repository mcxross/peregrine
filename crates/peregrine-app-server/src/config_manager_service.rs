...
use peregrine_app_server_protocol::Config as ApiConfig;
...
use peregrine_app_server_protocol::OverriddenMetadata;
...
use peregrine_config::merge_toml_values;
use peregrine_core::config::deserialize_config_toml_with_base;
use peregrine_core::config::edit::ConfigEdit;
use peregrine_core::config::edit::ConfigEditsBuilder;
use peregrine_core::config::validate_feature_requirements_for_config_toml;
use peregrine_core::path_utils;
use peregrine_core::path_utils::SymlinkWritePaths;
use peregrine_core::path_utils::resolve_symlink_write_paths;
...
impl ConfigManager {
    ...
    async fn apply_edits(
        ...
        let user_config_toml =
            deserialize_config_toml_with_base(user_config.clone(), self.peregrine_home()).map_err(
                |err| {
                    ConfigManagerError::write(
                        ConfigWriteErrorCode::ConfigValidationError,
                        format!("Invalid configuration: {err}"),
    ...
    /// include any in-repo .peregrine/ folders because there is no cwd/project root
