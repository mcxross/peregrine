...
use peregrine_app_server_protocol::AccountRateLimitsUpdatedNotification;
use peregrine_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use peregrine_app_server_protocol::CommandAction as V2ParsedCommand;
use peregrine_app_server_protocol::CommandExecutionApprovalDecision;
use peregrine_app_server_protocol::CommandExecutionRequestApprovalParams;
use peregrine_app_server_protocol::CommandExecutionRequestApprovalResponse;
use peregrine_app_server_protocol::CommandExecutionSource;
use peregrine_app_server_protocol::CommandExecutionStatus;
use peregrine_app_server_protocol::DeprecationNoticeNotification;
use peregrine_app_server_protocol::DynamicToolCallParams;
use peregrine_app_server_protocol::DynamicToolCallStatus;
use peregrine_app_server_protocol::ErrorNotification;
use peregrine_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use peregrine_app_server_protocol::FileChangeApprovalDecision;
use peregrine_app_server_protocol::FileChangeRequestApprovalParams;
use peregrine_app_server_protocol::FileChangeRequestApprovalResponse;
use peregrine_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use peregrine_app_server_protocol::GuardianWarningNotification;
use peregrine_app_server_protocol::HookCompletedNotification;
use peregrine_app_server_protocol::HookStartedNotification;
use peregrine_app_server_protocol::ItemCompletedNotification;
use peregrine_app_server_protocol::ItemStartedNotification;
use peregrine_app_server_protocol::McpServerElicitationAction;
use peregrine_app_server_protocol::McpServerElicitationRequestParams;
use peregrine_app_server_protocol::McpServerElicitationRequestResponse;
use peregrine_app_server_protocol::McpServerStartupState;
use peregrine_app_server_protocol::McpServerStatusUpdatedNotification;
use peregrine_app_server_protocol::ModelReroutedNotification;
use peregrine_app_server_protocol::ModelVerificationNotification;
use peregrine_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use peregrine_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use peregrine_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use peregrine_app_server_protocol::PeregrineErrorInfo as V2PeregrineErrorInfo;
use peregrine_app_server_protocol::PermissionsRequestApprovalParams;
use peregrine_app_server_protocol::PermissionsRequestApprovalResponse;
use peregrine_app_server_protocol::RawResponseItemCompletedNotification;
use peregrine_app_server_protocol::RequestId;
use peregrine_app_server_protocol::ServerNotification;
use peregrine_app_server_protocol::ServerRequestPayload;
use peregrine_app_server_protocol::ThreadGoalUpdatedNotification;
use peregrine_app_server_protocol::ThreadItem;
use peregrine_app_server_protocol::ThreadRealtimeClosedNotification;
use peregrine_app_server_protocol::ThreadRealtimeErrorNotification;
use peregrine_app_server_protocol::ThreadRealtimeItemAddedNotification;
use peregrine_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use peregrine_app_server_protocol::ThreadRealtimeSdpNotification;
use peregrine_app_server_protocol::ThreadRealtimeStartedNotification;
use peregrine_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use peregrine_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use peregrine_app_server_protocol::ThreadRollbackResponse;
use peregrine_app_server_protocol::ThreadSettingsUpdatedNotification;
use peregrine_app_server_protocol::ThreadStatus;
use peregrine_app_server_protocol::ThreadTokenUsage;
use peregrine_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use peregrine_app_server_protocol::ToolRequestUserInputOption;
use peregrine_app_server_protocol::ToolRequestUserInputParams;
use peregrine_app_server_protocol::ToolRequestUserInputQuestion;
use peregrine_app_server_protocol::ToolRequestUserInputResponse;
use peregrine_app_server_protocol::Turn;
use peregrine_app_server_protocol::TurnCompletedNotification;
use peregrine_app_server_protocol::TurnDiffUpdatedNotification;
...
use peregrine_app_server_protocol::TurnPlanStep;
use peregrine_app_server_protocol::TurnPlanUpdatedNotification;
use peregrine_app_server_protocol::TurnStartedNotification;
use peregrine_app_server_protocol::TurnStatus;
use peregrine_app_server_protocol::WarningNotification;
use peregrine_app_server_protocol::build_item_from_guardian_event;
use peregrine_app_server_protocol::guardian_auto_approval_review_notification;
use peregrine_app_server_protocol::item_event_to_server_notification;
use peregrine_core::PeregrineThread;
use peregrine_core::ThreadManager;
use peregrine_core::review_format::format_review_findings_block;
use peregrine_core::review_prompts;
use peregrine_types::ThreadId;
use peregrine_types::items::parse_hook_prompt_message;
use peregrine_types::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use peregrine_types::plan_tool::UpdatePlanArgs;
use peregrine_types::protocol::Event;
use peregrine_types::protocol::EventMsg;
use peregrine_types::protocol::ExecApprovalRequestEvent;
use peregrine_types::protocol::Op;
use peregrine_types::protocol::PeregrineErrorInfo as CorePeregrineErrorInfo;
use peregrine_types::protocol::RealtimeEvent;
use peregrine_types::protocol::ReviewDecision;
use peregrine_types::protocol::ReviewOutputEvent;
use peregrine_types::protocol::TokenCountEvent;
use peregrine_types::protocol::TurnAbortedEvent;
use peregrine_types::protocol::TurnCompleteEvent;
use peregrine_types::protocol::TurnDiffEvent;
use peregrine_types::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use peregrine_types::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use peregrine_types::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use peregrine_types::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use peregrine_types::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<PeregrineThread>,
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error) = match update.status {
                peregrine_types::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None)
                }
                peregrine_types::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None)
                }
                peregrine_types::protocol::McpStartupStatus::Failed { error } => {
                    (McpServerStartupState::Failed, Some(error))
                }
                peregrine_types::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == peregrine_types::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                peregrine_types::protocol::GuardianAssessmentStatus::Denied
                | peregrine_types::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                peregrine_types::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                peregrine_types::protocol::GuardianAssessmentStatus::InProgress
                | peregrine_types::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: peregrine_types::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let peregrine_error_info = ev.codex_error_info.clone();
            ...
            if matches!(
                peregrine_error_info,
                Some(CorePeregrineErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                peregrine_error_info: ev.codex_error_info.map(V2PeregrineErrorInfo::from),
        ...
        EventMsg::ExecCommandBegin(exec_command_begin_event) => {
            if matches!(
                ...
                peregrine_types::protocol::ExecCommandSource::UnifiedExecInteraction
            ) {
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: peregrine_types::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
pub(crate) async fn maybe_emit_hook_prompt_item_completed(
    ...
    let peregrine_types::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(peregrine_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: peregrine_types::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<PeregrineThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: peregrine_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            peregrine_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use peregrine_app_server_protocol::AutoReviewDecisionSource;
    use peregrine_app_server_protocol::GuardianApprovalReviewStatus;
    use peregrine_app_server_protocol::JSONRPCErrorError;
    use peregrine_app_server_protocol::TurnPlanStepStatus;
    use peregrine_types::items::HookPromptFragment;
    use peregrine_types::items::build_hook_prompt_message;
    use peregrine_types::models::FileSystemPermissions as CoreFileSystemPermissions;
    use peregrine_types::models::NetworkPermissions as CoreNetworkPermissions;
    ...
    use peregrine_types::protocol::AgentMessageEvent;
    use peregrine_types::protocol::AskForApproval;
    use peregrine_types::protocol::CreditsSnapshot;
    use peregrine_types::protocol::EventMsg;
    use peregrine_types::protocol::GuardianAssessmentEvent;
    use peregrine_types::protocol::GuardianAssessmentStatus;
    use peregrine_types::protocol::RateLimitSnapshot;
    use peregrine_types::protocol::RateLimitWindow;
    ...
    use peregrine_types::protocol::UserMessageEvent;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            reason: peregrine_types::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(peregrine_types::protocol::GuardianRiskLevel::Low),
                Some(peregrine_types::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(peregrine_types::protocol::GuardianRiskLevel::High),
                Some(peregrine_types::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(peregrine_types::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = peregrine_types::protocol::GuardianAssessmentAction::Command {
            source: peregrine_types::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: peregrine_types::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: peregrine_types::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(peregrine_types::protocol::GuardianRiskLevel::High),
                user_authorization: Some(peregrine_types::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    peregrine_types::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(peregrine_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(peregrine_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = peregrine_types::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: peregrine_types::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: peregrine_types::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&peregrine_home).await;
        let thread_manager = Arc::new(
            peregrine_core::test_support::thread_manager_with_models_provider_and_home(
    ...
    fn request_permissions_response_preserves_turn_scoped_strict_auto_review() {
        let response = request_permissions_response_from_client_result(
            CoreRequestPermissionProfile {
                network: Some(peregrine_types::models::NetworkPermissions {
                    enabled: Some(true),
                }),
                ..Default::default()
            },
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                peregrine_error_info: Some(V2PeregrineErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(peregrine_types::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(peregrine_types::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(peregrine_types::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                peregrine_error_info: Some(V2PeregrineErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                peregrine_error_info: Some(V2PeregrineErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            peregrine_app_server_protocol::HookPromptFragment {
