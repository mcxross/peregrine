...
use peregrine_app_server_protocol::ExperimentalFeature;
...
use peregrine_app_server_protocol::ExperimentalFeatureStage;
...
-> Result<()> {
    let peregrine_home = TempDir::new()?;
    let project_cwd = peregrine_home.path().join("project");
