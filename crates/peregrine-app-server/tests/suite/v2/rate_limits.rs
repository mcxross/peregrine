...
async fn get_account_rate_limits_returns_snapshot() -> Result<()> {
    ...
    write_chatgpt_base_url(peregrine_home.path(), &server_url)?;
    ...
    let response_body = json!({
        ...
        "additional_rate_limits": [
            {
                "limit_name": "peregrine_other",
                "metered_feature": "peregrine_other",
                "rate_limit": {
                    "allowed": true,
                    "limit_reached": false,
                    "primary_window": {
...
fn write_chatgpt_base_url(peregrine_home: &Path, base_url: &str) -> std::io::Result<()> {
