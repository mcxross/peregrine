...
use peregrine_app_server_protocol::AppBranding;
use peregrine_app_server_protocol::AppInfo;
use peregrine_app_server_protocol::AppListUpdatedNotification;
use peregrine_app_server_protocol::AppMetadata;
use peregrine_app_server_protocol::AppReview;
use peregrine_app_server_protocol::AppScreenshot;
...
#[tokio::test]
async fn list_apps_returns_empty_when_workspace_peregrine_plugins_disabled() -> Result<()> {
    let connectors = vec![AppInfo {
        id: "beta".to_string(),
        name: "Beta".to_string(),
        description: Some("Beta connector".to_string()),
