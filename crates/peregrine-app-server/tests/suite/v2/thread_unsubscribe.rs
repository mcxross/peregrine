...
use peregrine_app_server_protocol::DynamicToolCallOutputContentItem;
use peregrine_app_server_protocol::DynamicToolCallParams;
use peregrine_app_server_protocol::DynamicToolCallResponse;
