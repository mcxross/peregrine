...
//! [`InProcessClientHandle`](peregrine_app_server::in_process::InProcessClientHandle),
...
pub use peregrine_app_server::app_server_control_socket_path;
pub use peregrine_app_server::in_process::DEFAULT_IN_PROCESS_CHANNEL_CAPACITY;
pub use peregrine_app_server::in_process::InProcessServerEvent;
use peregrine_app_server::in_process::InProcessStartArgs;
use peregrine_app_server::in_process::LogDbLayer;
pub use peregrine_app_server::in_process::StateDbHandle;
...
use peregrine_app_server_protocol::Result as JsonRpcResult;
...
use peregrine_config::NoopThreadConfigLoader;
use peregrine_config::RemoteThreadConfigLoader;
...
/// module exists so clients can remove a direct `peregrine-core` dependency
/// while legacy startup/config paths are migrated to RPCs.
pub mod legacy_core {
    pub use peregrine_core::DEFAULT_AGENTS_MD_FILENAME;
    pub use peregrine_core::LOCAL_AGENTS_MD_FILENAME;
    pub use peregrine_core::McpManager;
    pub use peregrine_core::check_execpolicy_for_warnings;
    pub use peregrine_core::format_exec_policy_error_with_source;
    pub use peregrine_core::grant_read_root_non_elevated;
    pub use peregrine_core::web_search_detail;

    pub mod config {
        pub use peregrine_core::config::*;

        pub mod edit {
            pub use peregrine_core::config::edit::*;
        }
    }

    pub mod connectors {
        pub use peregrine_core::connectors::*;
    }

    pub mod otel_init {
        pub use peregrine_core::otel_init::*;
    }

    pub mod personality_migration {
        pub use peregrine_core::personality_migration::*;
    }

    pub mod review_format {
        pub use peregrine_core::review_format::*;
    }
    ...
    pub mod windows_sandbox {
        pub use peregrine_core::windows_sandbox::*;
    }
}
...
pub struct InProcessClientStartArgs {
    ...
    /// Whether auth loading should honor the `PEREGRINE_API_KEY` environment variable.
    pub enable_peregrine_api_key_env: bool,
...
impl InProcessClientStartArgs {
    ...
    fn into_runtime_start_args(self) -> InProcessStartArgs {
        ...
        InProcessStartArgs {
            ...
            enable_peregrine_api_key_env: self.enable_peregrine_api_key_env,
            initialize,
...
/// - [`peregrine_app_server::in_process::InProcessClientHandle`], which speaks to
...
impl InProcessAppServerClient {
    ...
    pub async fn start(args: InProcessClientStartArgs) -> IoResult<Self> {
        ...
        let mut handle =
            peregrine_app_server::in_process::start(args.into_runtime_start_args()).await?;
...
impl InProcessAppServerRequestHandle {
    ...
    /// Resolves a pending server request using a cloned request handle.
    pub async fn resolve_server_request(
        &self,
        request_id: RequestId,
        result: JsonRpcResult,
    ...
    /// Rejects a pending server request using a cloned request handle.
    pub async fn reject_server_request(
        &self,
        request_id: RequestId,
        error: JSONRPCErrorError,
...
mod tests {
    ...
    use peregrine_app_server_protocol::ServerNotification;
    use peregrine_app_server_protocol::SessionSource as ApiSessionSource;
    ...
    fn run_in_process_test<F, Fut>(name: &'static str, test: F)
    where
    ...
    async fn build_test_config_for_peregrine_home(peregrine_home: &Path) -> Config {
        ...
        {
            Ok(config) => config,
            Err(_) => Config::load_default_with_cli_overrides_for_peregrine_home(
    ...
    async fn start_test_client_with_capacity(
        ...
        let peregrine_home = TempDir::new().expect("temp dir");
        let config = Arc::new(build_test_config_for_peregrine_home(peregrine_home.path()).await);
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            client_name: "peregrine-app-server-client-test".to_string(),
        ...
        write_websocket_message(
            ...
            JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "peregrine_cli_rs/9.8.7-test (Test OS; x86_64) rust",
                }),
            }),
        )
        .await;
    ...
    fn command_execution_output_delta_notification(delta: &str) -> ServerNotification {
        ServerNotification::CommandExecutionOutputDelta(
            peregrine_app_server_protocol::CommandExecutionOutputDeltaNotification {
    ...
    fn agent_message_delta_notification(delta: &str) -> ServerNotification {
        ServerNotification::AgentMessageDelta(
            peregrine_app_server_protocol::AgentMessageDeltaNotification {
                thread_id: "thread".to_string(),
                turn_id: "turn".to_string(),
                item_id: "item".to_string(),
                delta: delta.to_string(),
    ...
    fn item_completed_notification(text: &str) -> ServerNotification {
        ServerNotification::ItemCompleted(
            peregrine_app_server_protocol::ItemCompletedNotification {
                ...
                turn_id: "turn".to_string(),
                completed_at_ms: 0,
                item: peregrine_app_server_protocol::ThreadItem::AgentMessage {
                    id: "item".to_string(),
                    text: text.to_string(),
                    phase: None,
    ...
    fn turn_completed_notification() -> ServerNotification {
        ServerNotification::TurnCompleted(
            peregrine_app_server_protocol::TurnCompletedNotification {
                thread_id: "thread".to_string(),
                turn: peregrine_app_server_protocol::Turn {
                    id: "turn".to_string(),
                    items_view: peregrine_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: peregrine_app_server_protocol::TurnStatus::Completed,
                    error: None,
                    started_at: None,
                    completed_at: Some(0),
                    duration_ms: Some(1),
    ...
    fn typed_request_roundtrip_works() {
        run_in_process_test("typed_request_roundtrip_works", || async {
    ...
    fn typed_request_reports_json_rpc_errors() {
        run_in_process_test("typed_request_reports_json_rpc_errors", || async {
            let client = start_test_client(SessionSource::Exec).await;
            let err = client
                .request_typed::<ConfigRequirementsReadResponse>(ClientRequest::ThreadRead {
                    request_id: RequestId::Integer(99),
                    params: peregrine_app_server_protocol::ThreadReadParams {
    ...
    fn caller_provided_session_source_is_applied() {
        run_in_process_test("caller_provided_session_source_is_applied", || async {
        ...
        run_in_process_test(
            ...
            || async {
                ...
                let response: ThreadStartResponse = client
                    ...
                    .expect("thread/start should succeed");
                let read = client
                    .request_typed::<peregrine_app_server_protocol::ThreadReadResponse>(
    ...
    fn tiny_channel_capacity_still_supports_request_roundtrip() {
        run_in_process_test(
            "tiny_channel_capacity_still_supports_request_roundtrip",
            || async {
    ...
    async fn forward_in_process_event_preserves_transcript_notifications_under_backpressure() {
        ...
        assert!(matches!(
            ...
            InProcessServerEvent::ServerNotification(ServerNotification::ItemCompleted(
                ...
                &notification.item,
                peregrine_app_server_protocol::ThreadItem::AgentMessage { text, .. } if text == "hello"
            )
        ));
        assert!(matches!(
            &events[4],
            InProcessServerEvent::ServerNotification(ServerNotification::TurnCompleted(
                notification
            )) if notification.turn.status == peregrine_app_server_protocol::TurnStatus::Completed
        ));
    }
    ...
    async fn remote_typed_request_roundtrip_works() {
        ...
        let response: GetAccountResponse = client
            .request_typed(ClientRequest::GetAccount {
                request_id: RequestId::Integer(1),
                params: peregrine_app_server_protocol::GetAccountParams {
                    refresh_token: false,
                },
            })
            .await
        ...
        for event in &remaining_events {
            match event {
                ...
                AppServerEvent::ServerNotification(ServerNotification::TurnCompleted(
                    ...
                    == peregrine_app_server_protocol::TurnStatus::Completed =>
                {
    ...
    fn event_requires_delivery_marks_transcript_and_terminal_events() {
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                peregrine_app_server_protocol::ServerNotification::TurnCompleted(
                    peregrine_app_server_protocol::TurnCompletedNotification {
                        thread_id: "thread".to_string(),
                        turn: peregrine_app_server_protocol::Turn {
                            id: "turn".to_string(),
        ...
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                peregrine_app_server_protocol::ServerNotification::AgentMessageDelta(
                    peregrine_app_server_protocol::AgentMessageDeltaNotification {
                        thread_id: "thread".to_string(),
                        turn_id: "turn".to_string(),
                        item_id: "item".to_string(),
        ...
        assert!(event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                peregrine_app_server_protocol::ServerNotification::ItemCompleted(
                    peregrine_app_server_protocol::ItemCompletedNotification {
                        thread_id: "thread".to_string(),
                        turn_id: "turn".to_string(),
                        completed_at_ms: 0,
        ...
        assert!(!event_requires_delivery(
            &InProcessServerEvent::ServerNotification(
                peregrine_app_server_protocol::ServerNotification::CommandExecutionOutputDelta(
                    peregrine_app_server_protocol::CommandExecutionOutputDeltaNotification {
                        thread_id: "thread".to_string(),
                        turn_id: "turn".to_string(),
                        item_id: "item".to_string(),
            ...
            EnvironmentManager::create_for_tests(
                ...
                Some(
                    ExecServerRuntimePaths::new(
                        ...
                        /*peregrine_linux_sandbox_exe*/ None,
                    )
    ...
    async fn runtime_start_args_use_remote_thread_config_loader_when_configured() {
        ...
        assert_eq!(
            err.code(),
            peregrine_config::ThreadConfigLoadErrorCode::RequestFailed
        );
    }
