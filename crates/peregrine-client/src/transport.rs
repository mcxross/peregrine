use crate::default_client::PeregrineHttpClient;
use crate::default_client::PeregrineRequestBuilder;
...
pub struct ReqwestTransport {
    client: PeregrineHttpClient,
}

impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: PeregrineHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<PeregrineRequestBuilder, TransportError> {
