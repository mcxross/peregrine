...
pub const SERVER_NAME: &str = "peregrine";
pub const SERVER_BINARY_NAME: &str = "peregrine-mcp-server";
pub const SERVER_PATH_ENV: &str = "PEREGRINE_MCP_SERVER_PATH";
...
pub mod tool_name {
    pub const STATIC_RULE_CATALOG: &str = "security_sui_static_rule_catalog";
    pub const PACKAGE_RESOLVE: &str = "security_sui_package_resolve";
    pub const MODULES: &str = "security_sui_modules";
    pub const SIGNATURES: &str = "security_sui_signatures";
    pub const IMPORT_PACKAGE: &str = "security_sui_import_package";
    pub const CREATE_PACKAGE: &str = "security_sui_create_package";
    pub const STATIC_ANALYZE_PACKAGE: &str = "security_sui_static_analyze_package";
    pub const SCANNER_REPORT: &str = "security_sui_scanner_report";
    pub const TEST_SCANNER_REPORT: &str = "security_sui_test_scanner_report";
    pub const PACKAGE_INSIGHTS: &str = "security_sui_package_insights";
    pub const GRAPHS: &str = "security_sui_graphs";
    pub const FUNCTION_STATE_GRAPH: &str = "security_sui_function_state_graph";
    pub const BYTECODE_VIEW: &str = "security_sui_bytecode_view";
    pub const BYTECODE_DECOMPILE: &str = "security_sui_bytecode_decompile";
    pub const SUI_COMMAND: &str = "security_sui_command";
    pub const MOVY_FUZZ: &str = "security_sui_movy_fuzz";
    pub const FORMAL_VERIFY: &str = "security_sui_formal_verify";
...
mod tests {
    ...
    fn inventory_defines_every_public_tool_once() {
        ...
        assert_eq!(names, tool_name::ALL.iter().copied().collect());
    }
    ...
    fn command_surface_does_not_expose_real_publish() {
        let definition = tool_definitions()
            .into_iter()
            .find(|definition| definition.name == tool_name::SUI_COMMAND)
            .expect("Sui command definition");
    ...
    fn executable_resolution_prefers_injected_then_sibling_then_path() {
        ...
        let path = std::env::join_paths([path_server.parent().expect("parent")]).expect("PATH");
