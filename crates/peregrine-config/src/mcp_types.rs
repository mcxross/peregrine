...
/// OAuth client settings used when Peregrine launches an MCP OAuth flow.
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, JsonSchema)]
#[schemars(deny_unknown_fields)]
...
pub struct McpServerConfig {
    ...
    /// Effective environment id for where Peregrine should start this MCP server.
    pub environment_id: String,

    /// When `false`, Peregrine skips initializing this MCP server.
