...
//! `~/.peregrine/config.toml` and normalizes user-entered key specs into canonical
//! forms consumed by runtime keymap resolution in `peregrine-rs/tui/src/keymap.rs`.
//!
//! Responsibilities:
//!
