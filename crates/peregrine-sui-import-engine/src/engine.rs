...
use peregrine_sui_adapter::{SuiMoveBuildOptions, run_system_sui_move_build_blocking};
...
fn run_system_move_build(
    ...
    let options = SuiMoveBuildOptions {
        default_move_flavor: default_move_flavor.map(ToOwned::to_owned),
    };
    match run_system_sui_move_build_blocking(executable, package_root, &options) {
...
mod tests {
    use super::*;
    use peregrine_sui_package_resolution::FetchedMoveModule;
