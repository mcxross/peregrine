...
use peregrine_types::protocol::AgentReasoningEvent;
use peregrine_types::protocol::AgentReasoningRawContentEvent;
use peregrine_types::protocol::AgentStatus;
use peregrine_types::protocol::ApplyPatchApprovalRequestEvent;
use peregrine_types::protocol::CompactedItem;
use peregrine_types::protocol::ContextCompactedEvent;
use peregrine_types::protocol::DynamicToolCallResponseEvent;
use peregrine_types::protocol::ErrorEvent;
use peregrine_types::protocol::EventMsg;
use peregrine_types::protocol::ExecCommandBeginEvent;
use peregrine_types::protocol::ExecCommandEndEvent;
use peregrine_types::protocol::GuardianAssessmentEvent;
use peregrine_types::protocol::GuardianAssessmentStatus;
use peregrine_types::protocol::ImageGenerationBeginEvent;
use peregrine_types::protocol::ImageGenerationEndEvent;
use peregrine_types::protocol::ItemCompletedEvent;
use peregrine_types::protocol::ItemStartedEvent;
use peregrine_types::protocol::McpToolCallBeginEvent;
use peregrine_types::protocol::McpToolCallEndEvent;
use peregrine_types::protocol::PatchApplyBeginEvent;
use peregrine_types::protocol::PatchApplyEndEvent;
...
use peregrine_types::protocol::ViewImageToolCallEvent;
use peregrine_types::protocol::WebSearchBeginEvent;
use peregrine_types::protocol::WebSearchEndEvent;
...
#[cfg(test)]
use peregrine_types::protocol::ExecCommandStatus as CoreExecCommandStatus;
#[cfg(test)]
use peregrine_types::protocol::PatchApplyStatus as CorePatchApplyStatus;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `peregrine-rs/core/rollout/policy.rs`.
    ...
    fn handle_response_item(&mut self, item: &peregrine_types::models::ResponseItem) {
    ...
    fn handle_item_started(&mut self, payload: &ItemStartedEvent) {
        match &payload.item {
            peregrine_types::items::TurnItem::Plan(plan) => {
            ...
            peregrine_types::items::TurnItem::UserMessage(_)
            | peregrine_types::items::TurnItem::HookPrompt(_)
            | peregrine_types::items::TurnItem::AgentMessage(_)
            | peregrine_types::items::TurnItem::Reasoning(_)
            | peregrine_types::items::TurnItem::WebSearch(_)
            | peregrine_types::items::TurnItem::ImageView(_)
            | peregrine_types::items::TurnItem::ImageGeneration(_)
            | peregrine_types::items::TurnItem::FileChange(_)
            | peregrine_types::items::TurnItem::McpToolCall(_)
            | peregrine_types::items::TurnItem::ContextCompaction(_) => {}
        }
    }
    ...
    fn handle_dynamic_tool_call_request(
        &mut self,
        payload: &peregrine_types::dynamic_tools::DynamicToolCallRequest,
    ) {
    ...
    fn handle_collab_agent_spawn_begin(
        &mut self,
        payload: &peregrine_types::protocol::CollabAgentSpawnBeginEvent,
    ) {
    ...
    fn handle_collab_agent_spawn_end(
        &mut self,
        payload: &peregrine_types::protocol::CollabAgentSpawnEndEvent,
    ) {
    ...
    fn handle_collab_agent_interaction_begin(
        &mut self,
        payload: &peregrine_types::protocol::CollabAgentInteractionBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_agent_interaction_end(
        &mut self,
        payload: &peregrine_types::protocol::CollabAgentInteractionEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
    ...
    fn handle_collab_waiting_begin(
        &mut self,
        payload: &peregrine_types::protocol::CollabWaitingBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_waiting_end(
        &mut self,
        payload: &peregrine_types::protocol::CollabWaitingEndEvent,
    ) {
    ...
    fn handle_collab_close_begin(
        &mut self,
        payload: &peregrine_types::protocol::CollabCloseBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_close_end(
        &mut self,
        payload: &peregrine_types::protocol::CollabCloseEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_collab_resume_begin(
        &mut self,
        payload: &peregrine_types::protocol::CollabResumeBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_end(
        &mut self,
        payload: &peregrine_types::protocol::CollabResumeEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_entered_review_mode(&mut self, payload: &peregrine_types::protocol::ReviewRequest) {
        let review = payload
            .user_facing_hint
            .clone()
    ...
    fn handle_exited_review_mode(
        &mut self,
        payload: &peregrine_types::protocol::ExitedReviewModeEvent,
    ) {
        let review = payload
            .review_output
            .as_ref()
    ...
    fn handle_error(&mut self, payload: &ErrorEvent) {
        ...
        turn.error = Some(V2TurnError {
            ...
            peregrine_error_info: payload.codex_error_info.clone().map(Into::into),
...
fn convert_dynamic_tool_content_items(
    items: &[peregrine_types::dynamic_tools::DynamicToolCallOutputContentItem],
) -> Vec<DynamicToolCallOutputContentItem> {
    items
        .iter()
        .cloned()
        .map(|item| match item {
            peregrine_types::dynamic_tools::DynamicToolCallOutputContentItem::InputText {
                text,
            } => DynamicToolCallOutputContentItem::InputText { text },
            peregrine_types::dynamic_tools::DynamicToolCallOutputContentItem::InputImage {
                image_url,
...
mod tests {
    ...
    use peregrine_types::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
    use peregrine_types::items::HookPromptFragment as CoreHookPromptFragment;
    use peregrine_types::items::TurnItem as CoreTurnItem;
    use peregrine_types::items::UserMessageItem as CoreUserMessageItem;
    ...
    use peregrine_types::models::MessagePhase as CoreMessagePhase;
    use peregrine_types::models::WebSearchAction as CoreWebSearchAction;
    use peregrine_types::parse_command::ParsedCommand;
    ...
    use peregrine_types::protocol::DynamicToolCallResponseEvent;
    use peregrine_types::protocol::ExecCommandEndEvent;
    use peregrine_types::protocol::ExecCommandSource;
    use peregrine_types::protocol::ItemStartedEvent;
    ...
    use peregrine_types::protocol::ThreadRolledBackEvent;
    use peregrine_types::protocol::TurnAbortReason;
    use peregrine_types::protocol::TurnAbortedEvent;
    use peregrine_types::protocol::TurnCompleteEvent;
    use peregrine_types::protocol::TurnStartedEvent;
    use peregrine_types::protocol::UserMessageEvent;
        ...
        let events = vec![
            ...
            EventMsg::ItemStarted(ItemStartedEvent {
                ...
                item: CoreTurnItem::UserMessage(CoreUserMessageItem {
                    ...
                    content: vec![peregrine_types::user_input::UserInput::Text {
                        text: "hello".into(),
                        text_elements: Vec::new(),
                    }],
                }),
    ...
    fn reconstructs_dynamic_tool_items_from_request_and_response_events() {
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                peregrine_types::dynamic_tools::DynamicToolCallRequest {
                    call_id: "dyn-1".into(),
                    turn_id: "turn-1".into(),
                    started_at_ms: 0,
                    namespace: Some("peregrine_app".into()),
        ...
        let events = vec![
            ...
            EventMsg::PatchApplyEnd(PatchApplyEndEvent {
                ...
                changes: [(
                    ...
                    peregrine_types::protocol::FileChange::Add {
                        content: "hello\n".into(),
                    },
                )]
                .into_iter()
    ...
    fn reconstructs_collab_resume_end_item() {
        let events = vec![
            ...
            EventMsg::CollabResumeEnd(peregrine_types::protocol::CollabResumeEndEvent {
    ...
    fn reconstructs_collab_spawn_end_item_with_model_metadata() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentSpawnEnd(peregrine_types::protocol::CollabAgentSpawnEndEvent {
                ...
                reasoning_effort: peregrine_types::openai_models::ReasoningEffort::Medium,
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                reasoning_effort: Some(peregrine_types::openai_models::ReasoningEffort::Medium),
                agents_states: [(
                    "00000000-0000-0000-0000-000000000002".into(),
                    CollabAgentState {
    ...
    fn reconstructs_interrupted_send_input_as_completed_collab_call() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentInteractionBegin(
                peregrine_types::protocol::CollabAgentInteractionBeginEvent {
                    call_id: "send-1".into(),
                    started_at_ms: 0,
            ...
            EventMsg::CollabAgentInteractionEnd(
                peregrine_types::protocol::CollabAgentInteractionEndEvent {
                    call_id: "send-1".into(),
                    completed_at_ms: 0,
                    sender_thread_id: sender,
                    receiver_thread_id: receiver,
    ...
    fn error_then_turn_complete_preserves_failed_status() {
        ...
        assert_eq!(
            ...
            Some(TurnError {
                message: "stream failure".into(),
                peregrine_error_info: Some(
                    crate::protocol::v2::PeregrineErrorInfo::ResponseStreamDisconnected {
                        http_status_code: Some(502),
                    }
                ),
                additional_details: None,
    ...
    fn ignores_plain_user_response_items_in_rollout_replay() {
        let items = vec![
            ...
            RolloutItem::ResponseItem(peregrine_types::models::ResponseItem::Message {
                id: Some("msg-1".into()),
                role: "user".into(),
