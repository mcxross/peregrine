...
use peregrine_types::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use peregrine_types::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use peregrine_types::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use peregrine_types::items::AgentMessageContent as CoreAgentMessageContent;
...
use peregrine_types::parse_command::ParsedCommand as CoreParsedCommand;
use peregrine_types::protocol::AgentStatus as CoreAgentStatus;
use peregrine_types::protocol::ExecCommandSource as CoreExecCommandSource;
use peregrine_types::protocol::ExecCommandStatus as CoreExecCommandStatus;
use peregrine_types::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use peregrine_types::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use peregrine_types::protocol::PatchApplyStatus as CorePatchApplyStatus;
use peregrine_types::protocol::ReviewDecision as CoreReviewDecision;
...
impl From<peregrine_types::models::WebSearchAction> for WebSearchAction {
    fn from(value: peregrine_types::models::WebSearchAction) -> Self {
        match value {
            peregrine_types::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            peregrine_types::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            peregrine_types::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            peregrine_types::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<peregrine_types::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: peregrine_types::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<DynamicToolCallOutputContentItem>
    for peregrine_types::dynamic_tools::DynamicToolCallOutputContentItem
{
