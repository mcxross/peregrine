...
pub enum ConfigLayerSource {
    ...
    /// User config layer from $PEREGRINE_HOME/config.toml. This layer is special
    ...
    /// Path to a .peregrine/ folder within a project. There could be multiple of
...
pub struct ExternalAgentConfigDetectParams {
    /// If true, include detection under the user's home (~/.claude, ~/.peregrine, etc.).
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
