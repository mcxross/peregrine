...
use peregrine_types::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use peregrine_types::config_types::SandboxMode as CoreSandboxMode;
...
use peregrine_types::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
...
impl From<CorePeregrineErrorInfo> for PeregrineErrorInfo {
    fn from(value: CorePeregrineErrorInfo) -> Self {
        match value {
            CorePeregrineErrorInfo::ContextWindowExceeded => {
                PeregrineErrorInfo::ContextWindowExceeded
            }
            CorePeregrineErrorInfo::UsageLimitExceeded => PeregrineErrorInfo::UsageLimitExceeded,
            CorePeregrineErrorInfo::ServerOverloaded => PeregrineErrorInfo::ServerOverloaded,
            CorePeregrineErrorInfo::CyberPolicy => PeregrineErrorInfo::CyberPolicy,
            CorePeregrineErrorInfo::HttpConnectionFailed { http_status_code } => {
                PeregrineErrorInfo::HttpConnectionFailed { http_status_code }
            }
            CorePeregrineErrorInfo::ResponseStreamConnectionFailed { http_status_code } => {
                PeregrineErrorInfo::ResponseStreamConnectionFailed { http_status_code }
            }
            CorePeregrineErrorInfo::InternalServerError => PeregrineErrorInfo::InternalServerError,
            CorePeregrineErrorInfo::Unauthorized => PeregrineErrorInfo::Unauthorized,
            CorePeregrineErrorInfo::BadRequest => PeregrineErrorInfo::BadRequest,
            CorePeregrineErrorInfo::ThreadRollbackFailed => {
                PeregrineErrorInfo::ThreadRollbackFailed
            }
            CorePeregrineErrorInfo::SandboxError => PeregrineErrorInfo::SandboxError,
            CorePeregrineErrorInfo::ResponseStreamDisconnected { http_status_code } => {
                PeregrineErrorInfo::ResponseStreamDisconnected { http_status_code }
            }
            CorePeregrineErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                PeregrineErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CorePeregrineErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                PeregrineErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CorePeregrineErrorInfo::Other => PeregrineErrorInfo::Other,
        }
    }
}
