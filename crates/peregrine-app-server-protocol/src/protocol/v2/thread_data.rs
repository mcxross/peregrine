use super::PeregrineErrorInfo;
use super::ThreadItem;
use super::ThreadStatus;
use super::TurnStatus;
use codex_utils_absolute_path::AbsolutePathBuf;
use peregrine_types::protocol::SessionSource as CoreSessionSource;
use peregrine_types::protocol::SubAgentSource as CoreSubAgentSource;
use peregrine_types::protocol::ThreadSource as CoreThreadSource;
...
pub struct TurnError {
    pub message: String,
    pub peregrine_error_info: Option<PeregrineErrorInfo>,
    #[serde(default)]
