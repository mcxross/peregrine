...
use peregrine_types::protocol::HookEventName as CoreHookEventName;
use peregrine_types::protocol::HookExecutionMode as CoreHookExecutionMode;
use peregrine_types::protocol::HookHandlerType as CoreHookHandlerType;
use peregrine_types::protocol::HookOutputEntry as CoreHookOutputEntry;
use peregrine_types::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use peregrine_types::protocol::HookRunStatus as CoreHookRunStatus;
use peregrine_types::protocol::HookRunSummary as CoreHookRunSummary;
use peregrine_types::protocol::HookScope as CoreHookScope;
use peregrine_types::protocol::HookSource as CoreHookSource;
use peregrine_types::protocol::HookTrustStatus as CoreHookTrustStatus;
