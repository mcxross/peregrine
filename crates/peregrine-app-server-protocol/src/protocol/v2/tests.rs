...
use peregrine_types::approvals::ElicitationRequest as CoreElicitationRequest;
use peregrine_types::items::AgentMessageContent;
use peregrine_types::items::AgentMessageItem;
use peregrine_types::items::FileChangeItem;
use peregrine_types::items::ImageViewItem;
use peregrine_types::items::McpToolCallItem;
use peregrine_types::items::McpToolCallStatus as CoreMcpToolCallStatus;
use peregrine_types::items::ReasoningItem;
use peregrine_types::items::TurnItem;
use peregrine_types::items::UserMessageItem;
use peregrine_types::items::WebSearchItem;
use peregrine_types::mcp::CallToolResult;
use peregrine_types::mcp::McpServerInfo;
use peregrine_types::memory_citation::MemoryCitation as CoreMemoryCitation;
use peregrine_types::memory_citation::MemoryCitationEntry as CoreMemoryCitationEntry;
...
use peregrine_types::permissions::FileSystemAccessMode as CoreFileSystemAccessMode;
use peregrine_types::permissions::FileSystemPath as CoreFileSystemPath;
use peregrine_types::permissions::FileSystemSandboxEntry as CoreFileSystemSandboxEntry;
use peregrine_types::permissions::FileSystemSpecialPath as CoreFileSystemSpecialPath;
use peregrine_types::protocol::AgentStatus as CoreAgentStatus;
use peregrine_types::protocol::AskForApproval as CoreAskForApproval;
use peregrine_types::protocol::GranularApprovalConfig as CoreGranularApprovalConfig;
use peregrine_types::protocol::NetworkAccess as CoreNetworkAccess;
use peregrine_types::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use peregrine_types::user_input::UserInput as CoreUserInput;
...
fn sandbox_policy_round_trips_external_sandbox_network_access() {
    ...
    assert_eq!(
        core_policy,
        peregrine_types::protocol::SandboxPolicy::ExternalSandbox {
...
fn sandbox_policy_round_trips_read_only_network_access() {
    ...
    assert_eq!(
        core_policy,
        peregrine_types::protocol::SandboxPolicy::ReadOnly {
            network_access: true,
        }
    );
...
fn sandbox_policy_round_trips_workspace_write_access() {
    ...
    assert_eq!(
        core_policy,
        peregrine_types::protocol::SandboxPolicy::WorkspaceWrite {
            writable_roots: vec![],
            network_access: true,
            exclude_tmpdir_env_var: false,
            exclude_slash_tmp: false,
...
fn core_turn_item_into_thread_item_converts_supported_variants() {
    let user_item = TurnItem::UserMessage(UserMessageItem {
        ...
        content: vec![
            ...
            CoreUserInput::Skill {
                ...
                path: PathBuf::from("/repo/.peregrine/skills/skill-creator/SKILL.md"),
            },
    ...
    let file_change_item = TurnItem::FileChange(FileChangeItem {
        ...
        .into_iter()
        .collect(),
        status: Some(peregrine_types::protocol::PatchApplyStatus::Completed),
        auto_approved: None,
...
fn plugin_share_params_and_response_serialization_use_camel_case_fields() {
    ...
    assert_eq!(
        serde_json::to_value(PluginShareCheckoutResponse {
            remote_plugin_id: "plugins~Plugin_00000000000000000000000000000000".to_string(),
            plugin_id: "gmail@peregrine-curated".to_string(),
            plugin_name: "gmail".to_string(),
            plugin_path,
            marketplace_name: "peregrine-curated".to_string(),
            marketplace_path,
        ...
        json!({
            "remotePluginId": "plugins~Plugin_00000000000000000000000000000000",
            "pluginId": "gmail@peregrine-curated",
            "pluginName": "gmail",
            "pluginPath": plugin_path_json,
            "marketplaceName": "peregrine-curated",
            "marketplacePath": marketplace_path_json,
            "remoteVersion": "1.2.3",
        }),
    );
...
#[test]
fn peregrine_error_info_serializes_http_status_code_in_camel_case() {
    let value = PeregrineErrorInfo::ResponseTooManyFailedAttempts {
...
#[test]
fn peregrine_error_info_serializes_cyber_policy_in_camel_case() {
    assert_eq!(
        serde_json::to_value(PeregrineErrorInfo::CyberPolicy).unwrap(),
        json!("cyberPolicy")
    );
}

#[test]
fn peregrine_error_info_serializes_active_turn_not_steerable_turn_kind_in_camel_case() {
    let value = PeregrineErrorInfo::ActiveTurnNotSteerable {
...
fn thread_settings_update_params_preserve_field_level_experimental_gates() {
    ...
    let collaboration_mode = ThreadSettingsUpdateParams {
        ...
        collaboration_mode: Some(peregrine_types::config_types::CollaborationMode {
            mode: peregrine_types::config_types::ModeKind::Plan,
