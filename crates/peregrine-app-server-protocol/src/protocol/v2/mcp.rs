...
use peregrine_types::items::McpToolCallError as CoreMcpToolCallError;
use peregrine_types::mcp::CallToolResult as CoreMcpCallToolResult;
use peregrine_types::mcp::McpServerInfo;
use peregrine_types::mcp::Resource as McpResource;
pub use peregrine_types::mcp::ResourceContent as McpResourceContent;
use peregrine_types::mcp::ResourceTemplate as McpResourceTemplate;
use peregrine_types::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from peregrine_types::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> peregrine_types::approvals::ElicitationAction {
        match self {
            Self::Accept => peregrine_types::approvals::ElicitationAction::Accept,
            Self::Decline => peregrine_types::approvals::ElicitationAction::Decline,
            Self::Cancel => peregrine_types::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Peregrine turn when this elicitation was observed, if app-server could correlate one.
    ///
