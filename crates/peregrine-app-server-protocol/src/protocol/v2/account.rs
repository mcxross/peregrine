...
use peregrine_types::account::ProviderAccount;
use peregrine_types::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use peregrine_types::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use peregrine_types::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use peregrine_types::protocol::RateLimitWindow as CoreRateLimitWindow;
...
pub enum LoginAccountParams {
    ...
    Chatgpt {
        ...
        peregrine_streamlined_login: bool,
    },
    #[serde(rename = "chatgptDeviceCode")]
    #[ts(rename = "chatgptDeviceCode")]
    ChatgptDeviceCode,
    /// [UNSTABLE] FOR OPENAI INTERNAL USE ONLY - DO NOT USE.
    /// The access token must contain the same scopes that Peregrine-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Peregrine attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Peregrine attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Peregrine was previously using.
    ///
