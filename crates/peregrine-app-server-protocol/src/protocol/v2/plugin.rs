...
use peregrine_types::protocol::SkillDependencies as CoreSkillDependencies;
use peregrine_types::protocol::SkillInterface as CoreSkillInterface;
use peregrine_types::protocol::SkillMetadata as CoreSkillMetadata;
use peregrine_types::protocol::SkillScope as CoreSkillScope;
use peregrine_types::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Peregrine app-server exposes `"AVAILABLE"` in its API; the alias keeps
