...
use peregrine_types::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use peregrine_types::protocol::TokenUsage as CoreTokenUsage;
use peregrine_types::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    /// This is for internal use only (e.g. Peregrine Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR PEREGRINE CLOUD - DO NOT USE.
...
impl From<peregrine_types::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: peregrine_types::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> peregrine_types::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => peregrine_types::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => peregrine_types::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `peregrine_types::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
