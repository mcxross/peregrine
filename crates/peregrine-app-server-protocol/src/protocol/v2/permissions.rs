...
use peregrine_types::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use peregrine_types::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use peregrine_types::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use peregrine_types::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use peregrine_types::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use peregrine_types::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> peregrine_types::protocol::SandboxPolicy {
        match self {
...
impl From<peregrine_types::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: peregrine_types::protocol::SandboxPolicy) -> Self {
        match value {
            peregrine_types::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            peregrine_types::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            peregrine_types::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
