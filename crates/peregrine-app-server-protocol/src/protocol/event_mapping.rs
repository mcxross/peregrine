    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                peregrine_types::protocol::AgentStatus::Errored(_)
                | peregrine_types::protocol::AgentStatus::NotFound => {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let peregrine_types::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
...
mod tests {
    ...
    use peregrine_types::protocol::CollabResumeBeginEvent;
    use peregrine_types::protocol::CollabResumeEndEvent;
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: peregrine_types::protocol::AgentStatus::NotFound,
        };
        ...
        assert_item_completed_server_notification(
            ...
            ItemCompletedNotification {
                ...
                item: ThreadItem::CollabAgentToolCall {
                    ...
                    agents_states: [(
                        receiver_id,
                        CollabAgentState::from(peregrine_types::protocol::AgentStatus::NotFound),
                    )]
                    .into_iter()
                    .collect(),
                },
