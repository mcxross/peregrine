...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Peregrine.
    ApiKey,
    /// ChatGPT OAuth managed by Peregrine (tokens persisted and refreshed by Peregrine).
    Chatgpt,
    ...
    ChatgptAuthTokens,
    /// Programmatic Peregrine auth backed by a registered Agent Identity.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Peregrine sandbox.
    ...
    AgentRoleRead => "agentRole/read" {
        params: v2::AgentRoleReadParams,
        serialization: global_shared_read("config"),
        response: v2::AgentRoleReadResponse,
    },
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Peregrine Cloud.
    ...
    fn serialize_initialize_with_opt_out_notification_methods() -> Result<()> {
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    "clientInfo": {
                        "name": "peregrine_vscode",
                        "title": "Peregrine VS Code Extension",
                        "version": "0.1.0"
                    },
                    "capabilities": {
    ...
    fn serialize_account_login_chatgpt_streamlined() -> Result<()> {
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    "type": "chatgpt",
                    "peregrineStreamlinedLogin": true
                }
            }),
            serde_json::to_value(&request)?,
        );
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: peregrine_types::config_types::CollaborationMode {
