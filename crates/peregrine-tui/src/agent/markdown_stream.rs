...
impl MarkdownStreamCollector {
    ...
    pub fn commit_complete_lines(&mut self) -> Vec<Line<'static>> {
        ...
        if complete_line_count > 0
            && crate::agent::render::line_utils::is_blank_line_spaces_only(
...
mod tests {
    ...
    async fn e2e_stream_blockquote_wrap_preserves_green_style() {
        ...
        let wrapped = crate::agent::wrapping::word_wrap_lines(
            out.iter(),
            crate::agent::wrapping::RtOptions::new(/*width*/ 24),
        );
    ...
    async fn heading_not_inlined_when_split_across_chunks() {
        ...
        crate::agent::markdown::append_markdown(
            "Hello.\n",
            /*width*/ None,
