...
use crate::agent::history_cell::padded_emoji;
...
pub(crate) async fn run_update_prompt_if_needed(
    ...
    let Some(update_action) = crate::agent::update_action::get_update_action() else {
        return Ok(UpdatePromptOutcome::Continue);
    };
...
impl WidgetRef for &UpdatePromptScreen {
    fn render_ref(&self, area: Rect, buf: &mut Buffer) {
        ...
        crate::agent::terminal_hyperlinks::mark_underlined_hyperlink(buf, area, RELEASE_NOTES_URL);
    }
}
