...
use peregrine_app_server_protocol::HookOutputEntry;
use peregrine_app_server_protocol::HookOutputEntryKind;
use peregrine_app_server_protocol::HookRunStatus;
use peregrine_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
...
mod tests {
    ...
    fn completed_hook_multiline_context_preserves_display_and_raw_lines() {
        ...
        let expected = vec![
            ...
            "".to_string(),
            "    Source: Peregrine compaction".to_string(),
