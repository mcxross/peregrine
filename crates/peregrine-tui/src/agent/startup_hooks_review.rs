...
use crate::agent::bottom_pane::ListSelectionView;
use crate::agent::bottom_pane::SelectionItem;
use crate::agent::bottom_pane::SelectionViewParams;
use crate::agent::bottom_pane::popup_consts::standard_popup_hint_line_for_keymap;
...
use crate::agent::hooks_rpc::hooks_list_entry_for_cwd;
...
mod tests {
    ...
    fn render_lines(view: &crate::agent::bottom_pane::ListSelectionView, width: u16) -> String {
