...
const APP_TOOLTIP: &str = "Try the **Peregrine App**. Run 'peregrine app' or visit https://chatgpt.com/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Peregrine App**. Run 'peregrine app' or visit https://chatgpt.com/codex?app-landing-page=true";
...
lazy_static! {
    static ref TOOLTIPS: Vec<&'static str> = RAW_TOOLTIPS
        ...
        .filter(|line| {
            ...
            if !IS_MACOS && !IS_WINDOWS && line.contains("peregrine app") {
                return false;
            }
            true
        })
...
pub(crate) mod announcement {
    use crate::agent::tooltips::ANNOUNCEMENT_TIP_URL;
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Peregrine currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
...
mod tests {
    use super::*;
    use crate::agent::tooltips::announcement::parse_announcement_tip_toml;
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Peregrine TUI.
...
[[announcements]]
content = "Welcome to Peregrine! Check out the new onboarding flow."
