...
use crate::agent::bottom_pane::ACTION_REQUIRED_PREVIEW_PREFIX;
use crate::agent::bottom_pane::CancellationEvent;
use crate::agent::bottom_pane::bottom_pane_view::BottomPaneView;
use crate::agent::bottom_pane::build_action_required_title_text;
use crate::agent::bottom_pane::multi_select_picker::MultiSelectItem;
use crate::agent::bottom_pane::multi_select_picker::MultiSelectPicker;
use crate::agent::bottom_pane::status_surface_preview::StatusSurfacePreviewData;
use crate::agent::bottom_pane::status_surface_preview::StatusSurfacePreviewItem;
...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Peregrine app name",
            ...
            TerminalTitleItem::PeregrineVersion => "Peregrine application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::PeregrineVersion => Some(StatusSurfacePreviewItem::PeregrineVersion),
    ...
    fn parse_terminal_title_items_accepts_kebab_case_variants() {
        ...
        assert_eq!(
            ...
            Some(vec![
                ...
                TerminalTitleItem::ModelWithReasoning,
                TerminalTitleItem::WeeklyLimit,
                TerminalTitleItem::PeregrineVersion,
