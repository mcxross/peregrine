...
use crate::agent::key_hint::is_altgr;
use crate::agent::keymap::EditorKeymap;
use crate::agent::keymap::RuntimeKeymap;
use crate::agent::keymap::VimNormalKeymap;
use crate::agent::keymap::VimOperatorKeymap;
use crate::agent::keymap::VimTextObjectKeymap;
use crossterm::event::KeyCode;
use crossterm::event::KeyEvent;
use crossterm::event::KeyEventKind;
use crossterm::event::KeyModifiers;
use peregrine_types::user_input::ByteRange;
use peregrine_types::user_input::TextElement as UserTextElement;
...
impl TextArea {
    ...
    fn wrapped_lines(&self, width: u16) -> Ref<'_, Vec<Range<usize>>> {
        // Ensure cache is ready (potentially mutably borrow, then drop)
        {
            ...
            if needs_recalc {
                let lines = crate::agent::wrapping::wrap_ranges(
                    &self.text,
