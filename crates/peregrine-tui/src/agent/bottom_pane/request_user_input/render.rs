...
use crate::agent::bottom_pane::selection_popup_common::wrap_styled_line;
...
struct UnansweredConfirmationData {
    ...
    rows: Vec<crate::agent::bottom_pane::selection_popup_common::GenericDisplayRow>,
    state: ScrollState,
}
...
fn render_rows_bottom_aligned(
    area: Rect,
    buf: &mut Buffer,
    rows: &[crate::agent::bottom_pane::selection_popup_common::GenericDisplayRow],
    state: &ScrollState,
    max_results: usize,
    empty_message: &str,
) {
