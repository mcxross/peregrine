...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "peregrine",
            ...
            StatusSurfacePreviewItem::PeregrineVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-peregrine medium",
