...
use crate::agent::bottom_pane::command_popup::CommandItem;
use crate::agent::bottom_pane::command_popup::CommandPopup;
use crate::agent::bottom_pane::command_popup::CommandPopupFlags;
...
use crate::agent::bottom_pane::slash_commands::has_slash_command_prefix;
...
mod tests {
    ...
    fn slash_completion_does_not_preserve_existing_draft_tail_for_other_commands() {
        ...
        assert_eq!(composer.draft.textarea.cursor(), "/provider ".len());
    }
