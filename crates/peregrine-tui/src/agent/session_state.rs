...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: peregrine_types::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<peregrine_types::openai_models::ReasoningEffort>,
