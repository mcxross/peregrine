...
use peregrine_config::types::KeybindingSpec;
use peregrine_config::types::KeybindingsSpec;
...
use crate::agent::app_event::KeymapEditIntent;
...
///
/// This converts resolved [`crate::agent::key_hint::KeyBinding`] values back into
...
fn key_parts_to_config_key_spec(
    ...
    let (code, normalized_modifiers) = crate::agent::key_hint::normalize_key_parts(code, modifiers);
