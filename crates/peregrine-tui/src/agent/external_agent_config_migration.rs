...
use crate::agent::selection_list::selection_option_row_with_dim;
...
mod tests {
    ...
    fn sample_plugin_details() -> peregrine_app_server_protocol::MigrationDetails {
        peregrine_app_server_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
