...
use crate::agent::workspace_command::WorkspaceCommand;
#[cfg(test)]
use crate::agent::workspace_command::WorkspaceCommandError;
use crate::agent::workspace_command::WorkspaceCommandExecutor;
use crate::agent::workspace_command::WorkspaceCommandOutput;
...
async fn run_git_command(
    ...
    cwd: &Path,
    args: &[&str],
) -> Result<WorkspaceCommandOutput, crate::agent::workspace_command::WorkspaceCommandError> {
