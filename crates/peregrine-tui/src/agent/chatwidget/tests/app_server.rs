...
fn thread_settings_for_test(
    model: &str,
    thread_id: ThreadId,
) -> peregrine_app_server_protocol::ThreadSettingsUpdatedNotification {
    peregrine_app_server_protocol::ThreadSettingsUpdatedNotification {
        thread_id: thread_id.to_string(),
        thread_settings: peregrine_app_server_protocol::ThreadSettings {
...
fn configured_thread_session(
    thread_id: ThreadId,
) -> crate::agent::session_state::ThreadSessionState {
    crate::agent::session_state::ThreadSessionState {
        thread_id,
        forked_from_id: None,
...
async fn invalid_url_elicitation_is_declined() {
    ...
    chat.handle_elicitation_request_now(
        peregrine_app_server_protocol::RequestId::Integer(9),
        peregrine_app_server_protocol::McpServerElicitationRequestParams {
            thread_id: request_thread_id.to_string(),
            turn_id: Some("turn-auth".to_string()),
            server_name: "payments".to_string(),
            request: peregrine_app_server_protocol::McpServerElicitationRequest::Url {
                meta: None,
    ...
    assert_matches!(
        ...
        Ok(AppEvent::SubmitThreadOp {
            ...
            op: Op::ResolveElicitation {
                server_name,
                request_id: peregrine_app_server_protocol::RequestId::Integer(9),
...
async fn thread_settings_updated_updates_visible_state_without_transcript() {
    ...
    assert_eq!(
        chat.config_ref()
            ...
            .id,
        peregrine_types::models::BUILT_IN_PERMISSION_PROFILE_READ_ONLY
    );
...
async fn live_app_server_turn_started_sets_feedback_turn_id() {
    ...
    assert_matches!(
        ...
        Ok(AppEvent::SubmitFeedback {
            category: crate::agent::app_event::FeedbackCategory::Bug,
            reason: None,
    ...
    chat.handle_server_notification(
        ServerNotification::Error(ErrorNotification {
            error: AppServerTurnError {
                ...
                peregrine_error_info: Some(PeregrineErrorInfo::Other),
                additional_details: None,
            },
            will_retry: true,
            thread_id: "thread-1".to_string(),
    ...
    chat.handle_server_notification(
        ServerNotification::Error(ErrorNotification {
            error: AppServerTurnError {
                ...
                peregrine_error_info: Some(PeregrineErrorInfo::ServerOverloaded),
                additional_details: None,
            },
            will_retry: false,
            thread_id: "thread-1".to_string(),
    ...
    chat.handle_server_notification(
        ServerNotification::Error(ErrorNotification {
            error: AppServerTurnError {
                ...
                peregrine_error_info: Some(PeregrineErrorInfo::CyberPolicy),
                additional_details: None,
            },
            will_retry: false,
            thread_id: "thread-1".to_string(),
