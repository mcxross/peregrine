...
impl ChatWidget {
    ...
    pub(crate) fn apply_model_provider_selection(&mut self, selection: ModelProviderSelection) {
        self.config.model_provider_id = selection.id.clone();
        self.runtime_model_provider_base_url = selection.runtime_base_url.clone();
        ...
        provider.name = selection.display_name;
