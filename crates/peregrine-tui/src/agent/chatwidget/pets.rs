...
) -> Option<crate::agent::pets::AmbientPet> {
    let selected_pet = config.tui_pet.as_deref()?;
    if selected_pet == crate::agent::pets::DISABLED_PET_ID {
        return None;
    }

    crate::agent::pets::AmbientPet::load(
        Some(selected_pet),
...
pub(super) fn start_configured_pet_load_if_needed(
    ...
    if pet_id == crate::agent::pets::DISABLED_PET_ID || !ambient_pet_missing {
        return;
    }
    ...
    spawn_pet_load(move || {
        let result = crate::agent::pets::ensure_builtin_pack_for_pet(&pet_id, &peregrine_home)
            .and_then(|()| {
                crate::agent::pets::AmbientPet::load(
                    Some(&pet_id),
                    &peregrine_home,
...
impl ChatWidget {
    pub(super) fn set_ambient_pet_notification(
        &mut self,
        kind: crate::agent::pets::PetNotificationKind,
        body: Option<String>,
    ) {
    ...
    pub(crate) fn ambient_pet_image_enabled(&self) -> bool {
        self.ambient_pet
            .as_ref()
            .is_some_and(crate::agent::pets::AmbientPet::image_enabled)
    }
    ...
    ) -> Option<crate::agent::pets::AmbientPetDraw> {
    ...
    pub(crate) fn pet_picker_preview_draw(&self) -> Option<crate::agent::pets::AmbientPetDraw> {
        self.bottom_pane
            .selected_index_for_active_view(crate::agent::pets::PET_PICKER_VIEW_ID)?;
    ...
    pub(crate) fn open_pets_picker(&mut self) {
        ...
        self.pet_picker_preview_pet = None;
        let params = crate::agent::pets::build_pet_picker_params(
        ...
        let initial_pet_id = self
            ...
            .tui_pet
            .as_deref()
            .unwrap_or(crate::agent::pets::DEFAULT_PET_ID)
            .to_string();
    ...
    fn pet_image_support(&self) -> crate::agent::pets::PetImageSupport {
        #[cfg(test)]
        ...
        #[cfg(test)]
        return crate::agent::pets::PetImageSupport::Unsupported(
            crate::agent::pets::PetImageUnsupportedReason::Terminal,
        );

        #[cfg(not(test))]
        crate::agent::pets::detect_pet_image_support()
    }
    ...
    pub(crate) fn start_pet_picker_preview(&mut self, pet_id: String) {
        ...
        self.pet_picker_preview_pet = None;
        if pet_id == crate::agent::pets::DISABLED_PET_ID {
    ...
    pub(crate) fn set_pet_image_support_for_tests(
        &mut self,
        support: crate::agent::pets::PetImageSupport,
    ) {
    ...
    pub(crate) fn install_test_ambient_pet_for_tests(&mut self, animations_enabled: bool) {
        self.set_tui_pet_loaded(
            Some("test".to_string()),
            Some(crate::agent::pets::test_ambient_pet(
