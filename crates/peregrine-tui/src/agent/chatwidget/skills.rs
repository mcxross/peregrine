...
use crate::agent::bottom_pane::SkillsToggleItem;
use crate::agent::bottom_pane::SkillsToggleView;
use crate::agent::bottom_pane::popup_consts::standard_popup_hint_line;
use crate::agent::skills_helpers::skill_description;
...
use peregrine_app_server_protocol::SkillsListEntry;
...
pub(crate) fn find_app_mentions(
    ...
    for app in apps.iter().filter(|app| is_app_mentionable(app)) {
        let slug = crate::agent::connector_metadata::connector_mention_slug(app);
