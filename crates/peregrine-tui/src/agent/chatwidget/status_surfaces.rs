...
use super::*;
use crate::agent::bottom_pane::status_line_from_segments;
use crate::agent::branch_summary;
use crate::agent::chatwidget::limit_label_for_window;
...
impl ChatWidget {
    ...
    fn action_required_terminal_title_text(
        ...
        crate::agent::bottom_pane::build_action_required_title_text(
    ...
    pub(super) fn status_line_value_for_item(&mut self, item: StatusLineItem) -> Option<String> {
        match item {
            ...
            StatusLineItem::PeregrineVersion => Some(CODEX_CLI_VERSION.to_string()),
    ...
    pub(super) fn status_surface_preview_value_for_item(
        ...
        let status_line_item = match item {
            StatusSurfacePreviewItem::AppName => return Some("peregrine".to_string()),
            ...
            StatusSurfacePreviewItem::PeregrineVersion => StatusLineItem::PeregrineVersion,
    ...
    pub(super) fn terminal_title_value_for_item(
        ...
        match item {
            TerminalTitleItem::AppName => Some("peregrine".to_string()),
            ...
            TerminalTitleItem::WeeklyLimit => self
                ...
                .map(|value| Self::truncate_terminal_title_part(value, /*max_chars*/ 32)),
            TerminalTitleItem::PeregrineVersion => self
                .status_line_value_for_item(StatusLineItem::PeregrineVersion)
                .map(|value| Self::truncate_terminal_title_part(value, /*max_chars*/ 32)),
