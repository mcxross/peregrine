...
impl ChatWidget {
    ...
    pub(crate) fn copy_last_agent_markdown(&mut self) {
        self.copy_last_agent_markdown_with(crate::agent::clipboard_copy::copy_to_clipboard);
    }
    ...
    pub(super) fn copy_last_agent_markdown_with(
        ...
        copy_fn: impl FnOnce(
            ...
            -> Result<Option<crate::agent::clipboard_copy::ClipboardLease>, String>,
    ) {
    ...
    pub(super) fn show_rename_prompt(&mut self) {
        ...
        let view = CustomPromptView::new(
            ...
            Box::new(move |name: String| {
                let Some(name) = crate::agent::legacy_core::util::normalize_thread_name(&name)
                else {
    ...
    pub(crate) fn handle_paste_burst_tick(&mut self, frame_requester: FrameRequester) -> bool {
        if self.bottom_pane.flush_paste_burst_if_due() {
            ...
            frame_requester.schedule_frame_in(
                crate::agent::bottom_pane::ChatComposer::recommended_paste_flush_delay(),
            );
            true
        } else {
            false
