//! Ambient terminal rendering for the Peregrine companion.
//!
...
impl AmbientPet {
    ...
    /// PEREGRINE_HOME cache, and records the terminal protocol support snapshot used
