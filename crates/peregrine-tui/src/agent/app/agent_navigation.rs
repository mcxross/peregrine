...
//!
//! This module exists to keep the pure parts of multi-agent navigation out of [`crate::agent::app::App`].
...
use crate::agent::multi_agents::next_agent_shortcut;
use crate::agent::multi_agents::previous_agent_shortcut;
