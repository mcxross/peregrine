...
mod tests {
    use super::*;
    use crate::agent::app::side::SideThreadState;
    use crate::agent::app::test_support::make_test_app;
    use crate::agent::app::thread_events::ThreadEventChannel;
    ...
    async fn permission_settings_sync_updates_active_snapshot_without_rewriting_side_thread() {
        ...
        app.config.permissions.approval_policy =
            peregrine_config::Constrained::allow_any(AskForApproval::OnRequest.to_core());
