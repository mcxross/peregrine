...
use super::*;
use crate::agent::chatwidget::InterruptedTurnNoticeMode;
...
impl App {
    pub(super) fn sync_side_thread_ui(&mut self) {
        let clear_side_ui = |chat_widget: &mut crate::agent::chatwidget::ChatWidget| {
    ...
    pub(super) fn restore_side_user_message(
        &mut self,
        user_message: Option<crate::agent::chatwidget::UserMessage>,
    ) {
    ...
    pub(super) async fn handle_start_side(
        ...
        app_server: &mut AppServerSession,
        parent_thread_id: ThreadId,
        mut user_message: Option<crate::agent::chatwidget::UserMessage>,
