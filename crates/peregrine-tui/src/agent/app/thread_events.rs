...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<peregrine_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use peregrine_app_server_protocol::HookEventName as AppServerHookEventName;
    use peregrine_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use peregrine_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use peregrine_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use peregrine_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use peregrine_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use peregrine_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use peregrine_app_server_protocol::HookScope as AppServerHookScope;
