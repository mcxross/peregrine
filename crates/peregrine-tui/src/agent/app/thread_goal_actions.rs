...
use crate::agent::goal_display::goal_status_label;
use crate::agent::goal_display::goal_usage_summary;
...
mod tests {
    ...
    fn thread_goal_ephemeral_error_message_renders_snapshot() {
        ...
        .wrap_err("thread/goal/get failed in TUI");
        let cell =
            crate::agent::history_cell::new_error_event(thread_goal_error_message("read", &err));
        let width = 72;
        let height = 6;
        let backend = crate::agent::test_backend::VT100Backend::new(width, height);
        let mut terminal =
        ...
        crate::agent::insert_history::insert_history_lines(
            &mut terminal,
