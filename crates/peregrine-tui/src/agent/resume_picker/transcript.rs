...
use crate::agent::history_cell::ReasoningSummaryCell;
        ...
        match item {
            ThreadItem::UserMessage {
                ...
                let item = UserMessageItem {
                    ...
                    content: content
                        .iter()
                        .cloned()
                        .map(peregrine_app_server_protocol::UserInput::into_core)
                        .collect(),
                };
            ...
            ThreadItem::Plan { text, .. } => {
                if !text.trim().is_empty() {
                    cells.push(Arc::new(crate::agent::history_cell::new_proposed_plan(
                        text.clone(),
                        cwd,
                    )));
                }
