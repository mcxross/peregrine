...
//! "leave the old title alone" or "clear the title Peregrine last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Peregrine manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Peregrine started managing the title.
