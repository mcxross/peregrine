...
use peregrine_app_server_protocol::GrantedPermissionProfile;
    ...
    fn converts_request_permissions_into_granted_permissions() {
        assert_eq!(
            granted_permission_profile_from_request(CoreRequestPermissionProfile::from(
                peregrine_app_server_protocol::RequestPermissionProfile {
                    network: Some(
                        peregrine_app_server_protocol::AdditionalNetworkPermissions {
                            enabled: Some(true),
                        }
                    ),
                    file_system: Some(
                        peregrine_app_server_protocol::AdditionalFileSystemPermissions {
            ...
            peregrine_app_server_protocol::GrantedPermissionProfile {
                network: Some(
                    peregrine_app_server_protocol::AdditionalNetworkPermissions {
                        enabled: Some(true),
                    }
                ...
                peregrine_app_server_protocol::RequestPermissionProfile {
                    ...
                    file_system: Some(
                        peregrine_app_server_protocol::AdditionalFileSystemPermissions {
                            ...
                            glob_scan_max_depth: None,
                            entries: Some(
                                vec![peregrine_app_server_protocol::FileSystemSandboxEntry {
                            path: peregrine_app_server_protocol::FileSystemPath::Special {
                                value: peregrine_app_server_protocol::FileSystemSpecialPath::Root,
                            },
                            access: peregrine_app_server_protocol::FileSystemAccessMode::Write,
                        }]
                            ),
                    ...
                    peregrine_app_server_protocol::AdditionalFileSystemPermissions {
                        ...
                        entries: Some(vec![
                            peregrine_app_server_protocol::FileSystemSandboxEntry {
                                path: peregrine_app_server_protocol::FileSystemPath::Special {
                                    value:
                                        peregrine_app_server_protocol::FileSystemSpecialPath::Root,
                                },
                                access: peregrine_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
