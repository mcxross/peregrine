...
//! which thread becomes active or when a thread closes, stays in [`crate::agent::app::App`].
...
use peregrine_app_server_protocol::CollabAgentState;
...
pub(crate) fn previous_agent_shortcut() -> crate::agent::key_hint::KeyBinding {
    crate::agent::key_hint::alt(KeyCode::Left)
}

pub(crate) fn next_agent_shortcut() -> crate::agent::key_hint::KeyBinding {
    crate::agent::key_hint::alt(KeyCode::Right)
}
