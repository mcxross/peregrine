...
use crate::agent::chatwidget::ActiveCellTranscriptKey;
...
use crate::agent::render::renderable::InsetRenderable;
...
impl PagerView {
    ...
    fn handle_key_event(&mut self, tui: &mut tui::Tui, key_event: KeyEvent) -> Result<()> {
        ...
        tui.frame_requester()
            .schedule_frame_in(crate::agent::tui::TARGET_FRAME_INTERVAL);
        Ok(())
    }
...
mod tests {
    ...
    use crate::agent::history_cell::HistoryCell;
    use crate::agent::history_cell::new_patch_event;
    ...
    impl crate::agent::history_cell::HistoryCell for TestCell {
    ...
    fn default_pager_keymap() -> crate::agent::keymap::PagerKeymap {
    ...
    fn transcript_overlay_apply_patch_scroll_vt100_clears_previous_page() {
        ...
        let mut exec_cell = crate::agent::exec_cell::new_active_exec_command(
            "exec-1".into(),
