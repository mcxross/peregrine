...
use crate::agent::history_cell::raw_lines_from_source;
use crate::agent::history_cell::{self};
use crate::agent::markdown::render_markdown_agent_with_links_and_cwd;
...
mod tests {
    ...
    fn controller_live_tail_rerenders_table_tail_after_resize() {
        ...
        for width in [48, 104, 56] {
            ...
            crate::agent::markdown::append_markdown_agent(
    ...
    fn controller_loose_vs_tight_with_commit_ticks_matches_full() {
        ...
        crate::agent::markdown::append_markdown_agent(&source, /*width*/ None, &mut rendered);
