...
use crate::agent::color::perceptual_distance;
use crate::agent::diff_model::FileChange;
use crate::agent::exec_command::relativize_to_home;
use crate::agent::render::Insets;
use crate::agent::render::highlight::DiffScopeBackgroundRgbs;
use crate::agent::render::highlight::diff_scope_background_rgbs;
use crate::agent::render::highlight::exceeds_highlight_limits;
use crate::agent::render::highlight::highlight_code_to_styled_spans;
...
use crate::agent::terminal_palette::XTERM_COLORS;
use crate::agent::terminal_palette::default_bg;
use crate::agent::terminal_palette::indexed_color;
use crate::agent::terminal_palette::rgb_color;
use crate::agent::terminal_palette::stdout_color_level;
