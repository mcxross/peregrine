...
pub struct TuiEventStream<S: EventSource + Default + Unpin = CrosstermEventSource> {
    ...
    #[cfg(unix)]
    suspend_context: crate::agent::tui::job_control::SuspendContext,
    #[cfg(unix)]
...
impl<S: EventSource + Default + Unpin> TuiEventStream<S> {
    pub fn new(
        ...
        terminal_focused: Arc<AtomicBool>,
        #[cfg(unix)] suspend_context: crate::agent::tui::job_control::SuspendContext,
    ...
    fn map_crossterm_event(&mut self, event: Event) -> Option<TuiEvent> {
        match event {
            Event::Key(key_event) => {
                #[cfg(unix)]
                if crate::agent::tui::job_control::SUSPEND_KEY.is_press(key_event) {
            ...
            Event::FocusGained => {
                ...
                crate::agent::terminal_palette::requery_default_colors();
                Some(TuiEvent::Draw)
            }
            Event::FocusLost => {
...
mod tests {
    ...
    fn make_stream(
        ...
        TuiEventStream::new(
            ...
            terminal_focused,
            #[cfg(unix)]
            crate::agent::tui::job_control::SuspendContext::new(),
            #[cfg(unix)]
