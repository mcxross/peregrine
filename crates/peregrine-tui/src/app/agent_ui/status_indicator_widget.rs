...
mod tests {
    ...
    fn renders_with_working_header() {
        ...
        let w = StatusIndicatorWidget::new(
            tx,
            crate::agent::tui::FrameRequester::test_dummy(),
    ...
    fn details_args_can_disable_capitalization_and_limit_lines() {
        ...
        w.update_details(
            Some("cargo test -p codex-core and then cargo test -p peregrine-tui".to_string()),
        ...
        assert_eq!(
            w.details(),
            Some("cargo test -p codex-core and then cargo test -p peregrine-tui")
        );
