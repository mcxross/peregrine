...
use crate::agent::render::highlight::foreground_style_for_scopes;
use crate::agent::render::highlight::highlight_code_to_lines;
use crate::agent::render::line_utils::line_to_static;
use crate::agent::style::table_separator_style;
use crate::agent::terminal_hyperlinks::HyperlinkLine;
use crate::agent::terminal_hyperlinks::annotate_web_urls_in_line;
use crate::agent::terminal_hyperlinks::remap_wrapped_line;
use crate::agent::terminal_hyperlinks::visible_lines;
use crate::agent::terminal_hyperlinks::web_destination;
use crate::agent::wrapping::RtOptions;
use crate::agent::wrapping::adaptive_wrap_line;
use crate::agent::wrapping::word_wrap_line;
...
///
/// This accepts the path shapes Peregrine emits today: `file://` URLs, absolute and relative paths,
