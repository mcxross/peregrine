...
pub(crate) fn append_markdown(
    ...
    let rendered = crate::agent::markdown_render::render_markdown_text_with_width_and_cwd(
        markdown_source,
        width,
        cwd,
    );
    crate::agent::render::line_utils::push_owned_lines(&rendered.lines, lines);
}
...
pub(crate) fn render_markdown_agent_with_links_and_cwd(
    ...
    let normalized = unwrap_markdown_fences(markdown_source);
    crate::agent::markdown_render::render_markdown_lines_with_width_and_cwd(&normalized, width, cwd)
}
