...
pub(crate) fn set_default_colors_from_startup_probe(
    colors: Option<crate::agent::terminal_probe::DefaultColors>,
) {
...
mod imp {
    ...
    fn query_default_colors() -> Option<DefaultColors> {
        crate::agent::terminal_probe::default_colors(crate::agent::terminal_probe::DEFAULT_TIMEOUT)
            .ok()
            .flatten()
...
mod imp {
    ...
    #[cfg(unix)]
    pub(super) fn set_default_colors_from_startup_probe(
        _colors: Option<crate::agent::terminal_probe::DefaultColors>,
    ) {
    }
