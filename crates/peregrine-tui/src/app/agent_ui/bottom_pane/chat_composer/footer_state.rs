...
use crate::agent::bottom_pane::footer::CollaborationModeIndicator;
use crate::agent::bottom_pane::footer::FooterMode;
use crate::agent::bottom_pane::footer::GoalStatusIndicator;
