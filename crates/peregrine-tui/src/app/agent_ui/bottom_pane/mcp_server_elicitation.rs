...
use peregrine_app_server_protocol::McpElicitationEnumSchema;
use peregrine_app_server_protocol::McpElicitationPrimitiveSchema;
use peregrine_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use peregrine_types::mcp_approval_meta::APPROVAL_KIND_KEY as APPROVAL_META_KIND_KEY;
use peregrine_types::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as APPROVAL_META_KIND_MCP_TOOL_CALL;
use peregrine_types::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as APPROVAL_META_KIND_TOOL_SUGGESTION;
use peregrine_types::mcp_approval_meta::PERSIST_ALWAYS as APPROVAL_PERSIST_ALWAYS_VALUE;
use peregrine_types::mcp_approval_meta::PERSIST_KEY as APPROVAL_PERSIST_KEY;
use peregrine_types::mcp_approval_meta::PERSIST_SESSION as APPROVAL_PERSIST_SESSION_VALUE;
use peregrine_types::mcp_approval_meta::TOOL_NAME_KEY;
use peregrine_types::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use peregrine_types::mcp_approval_meta::TOOL_PARAMS_KEY as APPROVAL_TOOL_PARAMS_KEY;
...
use crate::agent::bottom_pane::ChatComposerConfig;
use crate::agent::bottom_pane::InputResult;
use crate::agent::bottom_pane::bottom_pane_view::BottomPaneView;
use crate::agent::bottom_pane::scroll_state::ScrollState;
use crate::agent::bottom_pane::selection_popup_common::GenericDisplayRow;
use crate::agent::bottom_pane::selection_popup_common::measure_rows_height;
use crate::agent::bottom_pane::selection_popup_common::menu_surface_inset;
use crate::agent::bottom_pane::selection_popup_common::menu_surface_padding_height;
use crate::agent::bottom_pane::selection_popup_common::render_menu_surface;
use crate::agent::bottom_pane::selection_popup_common::render_rows;
use crate::agent::key_hint::KeyBindingListExt;
use crate::agent::keymap::ListKeymap;
use crate::agent::render::renderable::Renderable;
use crate::agent::text_formatting::format_json_compact;
