...
//! the stored cells as source, clears the Peregrine-owned terminal history, and re-emits the transcript
...
use crate::agent::transcript_reflow::TRANSCRIPT_REFLOW_DEBOUNCE;
use crate::agent::tui;
...
impl App {
    ...
    fn resize_reflow_max_rows(&self) -> Option<usize> {
        crate::agent::resize_reflow_cap::resize_reflow_max_rows(self.config.terminal_resize_reflow)
    }
