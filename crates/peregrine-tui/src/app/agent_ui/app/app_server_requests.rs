...
mod tests {
    ...
    use peregrine_app_server_protocol::McpElicitationObjectType;
    use peregrine_app_server_protocol::McpElicitationSchema;
    ...
    use peregrine_app_server_protocol::PermissionGrantScope;
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: peregrine_types::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: peregrine_types::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: peregrine_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        entries: Some(vec![
                            peregrine_app_server_protocol::FileSystemSandboxEntry {
                                path: peregrine_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path),
                                },
                                access: peregrine_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            peregrine_app_server_protocol::FileSystemSandboxEntry {
                                path: peregrine_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path),
                                },
                                access: peregrine_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: peregrine_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: peregrine_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason:
                        peregrine_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
