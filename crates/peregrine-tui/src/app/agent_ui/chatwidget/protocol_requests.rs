...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: peregrine_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, peregrine_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                peregrine_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                peregrine_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                peregrine_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                peregrine_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                peregrine_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                peregrine_app_server_protocol::GuardianRiskLevel::Low => {
                    peregrine_types::approvals::GuardianRiskLevel::Low
                }
                peregrine_app_server_protocol::GuardianRiskLevel::Medium => {
                    peregrine_types::approvals::GuardianRiskLevel::Medium
                }
                peregrine_app_server_protocol::GuardianRiskLevel::High => {
                    peregrine_types::approvals::GuardianRiskLevel::High
                }
                peregrine_app_server_protocol::GuardianRiskLevel::Critical => {
                    peregrine_types::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    peregrine_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        peregrine_types::approvals::GuardianUserAuthorization::Unknown
                    }
                    peregrine_app_server_protocol::GuardianUserAuthorization::Low => {
                        peregrine_types::approvals::GuardianUserAuthorization::Low
                    }
                    peregrine_app_server_protocol::GuardianUserAuthorization::Medium => {
                        peregrine_types::approvals::GuardianUserAuthorization::Medium
                    }
                    peregrine_app_server_protocol::GuardianUserAuthorization::High => {
                        peregrine_types::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                peregrine_app_server_protocol::AutoReviewDecisionSource::Agent => {
