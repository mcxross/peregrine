...
impl ChatWidget {
    pub(crate) fn new_with_app_event(common: ChatWidgetInit) -> Self {
        Self::new_with_op_target(common, PeregrineOpTarget::AppEvent)
    }
    ...
    pub(super) fn new_with_op_target(
        ...
        let effective_service_tier = crate::agent::service_tier_resolution::effective_service_tier(
            &config,
            &header_model,
        ...
        let mut widget = Self {
            ...
            ambient_pet: None,
            pet_picker_preview_state: crate::agent::pets::PetPickerPreviewState::default(),
            ...
            startup_tooltip_override,
            show_session_header_directory: true,
