...
impl ChatWidget {
    ...
    pub(crate) fn maybe_post_pending_notification(&mut self, tui: &mut crate::agent::tui::Tui) {
...
impl Notification {
    ...
    pub(super) fn user_input_request_summary(
        questions: &[peregrine_app_server_protocol::ToolRequestUserInputQuestion],
    ) -> Option<String> {
