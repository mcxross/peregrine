...
use crate::agent::chatwidget::UserMessage;
...
pub(crate) enum AppEvent {
    ...
    /// Return to the Peregrine workbench mode.
    SwitchToWorkbench,
    ...
    PetPreviewLoaded {
        request_id: u64,
        result: Result<crate::agent::pets::AmbientPet, String>,
    },
    ...
    PetSelectionLoaded {
        request_id: u64,
        pet_id: String,
        result: Result<Option<crate::agent::pets::AmbientPet>, String>,
    },
    ...
    HooksLoaded {
        cwd: PathBuf,
        result: Result<peregrine_app_server_protocol::HooksListResponse, String>,
    },
    ...
    /// Fetch providers from the app server and open the provider picker.
    OpenProviderPicker,

    /// Open the provider picker with app-server-supplied provider data.
    OpenProviderPopup {
        providers: ModelProviderListResponse,
    },

    /// Fetch provider-scoped models from the app server and open a model picker.
    OpenProviderModelPicker {
        provider_id: String,
        provider_display_name: String,
    },

    /// Open the provider model picker with app-server-supplied model data.
    OpenProviderModelPopup {
        provider_id: String,
        provider_display_name: String,
    ...
    TrustHooks {
        updates: Vec<crate::agent::hooks_rpc::HookTrustUpdate>,
    },
    ...
    StatusLineGitSummaryUpdated {
        cwd: PathBuf,
        summary: crate::agent::chatwidget::StatusLineGitSummary,
    },
