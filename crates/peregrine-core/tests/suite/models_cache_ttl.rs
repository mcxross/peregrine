...
const REMOTE_MODEL: &str = "peregrine-test-ttl";
const VERSIONED_MODEL: &str = "peregrine-test-versioned";
const MISSING_VERSION_MODEL: &str = "peregrine-test-missing-version";
const DIFFERENT_VERSION_MODEL: &str = "peregrine-test-different-version";
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    let codex = Arc::clone(&test.peregrine);
    ...
    let cache_path = config.peregrine_home.join(CACHE_FILE);
    ...
    codex
        .submit(Op::UserInput {
            ...
            thread_settings: peregrine_types::protocol::ThreadSettingsOverrides {
                ...
                approval_policy: Some(peregrine_types::protocol::AskForApproval::Never),
