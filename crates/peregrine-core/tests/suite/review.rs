...
use peregrine_core::REVIEW_PROMPT;
use peregrine_core::config::Config;
use peregrine_core::review_format::render_review_output_text;
use peregrine_types::models::ContentItem;
use peregrine_types::models::ResponseItem;
use peregrine_types::protocol::ENVIRONMENT_CONTEXT_OPEN_TAG;
use peregrine_types::protocol::EventMsg;
use peregrine_types::protocol::ExitedReviewModeEvent;
use peregrine_types::protocol::Op;
use peregrine_types::protocol::ReviewCodeLocation;
use peregrine_types::protocol::ReviewFinding;
use peregrine_types::protocol::ReviewLineRange;
use peregrine_types::protocol::ReviewOutputEvent;
use peregrine_types::protocol::ReviewRequest;
use peregrine_types::protocol::ReviewTarget;
...
async fn review_op_emits_lifecycle_and_review_output() {
    // Skip under Peregrine sandbox network restrictions.
    skip_if_no_network!();
    ...
    let codex = new_conversation_for_server(&server, peregrine_home.clone(), |_| {}).await;
...
async fn review_uses_custom_review_model_from_config() {
    ...
    let codex = new_conversation_for_server(&server, peregrine_home.clone(), |cfg| {
...
async fn review_input_isolated_from_parent_history() {
    ...
    let session_file = peregrine_home.path().join("resume.jsonl");
    {
        ...
        let user = peregrine_types::models::ResponseItem::Message {
            id: None,
            role: "user".to_string(),
        ...
        let assistant = peregrine_types::models::ResponseItem::Message {
            id: None,
...
async fn review_uses_overridden_cwd_for_base_branch_merge_base() {
    ...
    let codex = new_conversation_for_server(&server, peregrine_home.clone(), move |config| {
    ...
    F: FnOnce(&mut Config) + Send + 'static,
{
    ...
    builder
        .resume(server, peregrine_home, resume_path)
        .await
