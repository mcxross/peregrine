...
use peregrine_types::models::is_image_close_tag_text;
use peregrine_types::models::is_image_open_tag_text;
use peregrine_types::models::is_local_image_close_tag_text;
use peregrine_types::models::is_local_image_open_tag_text;
use peregrine_types::protocol::COLLABORATION_MODE_OPEN_TAG;
use peregrine_types::protocol::REALTIME_CONVERSATION_OPEN_TAG;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            peregrine_types::items::ImageGenerationItem {
                id: id.clone(),
                status: status.clone(),
