use crate::skills::AvailableSkills;
use crate::skills::render_available_skills_body;
use peregrine_types::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
use peregrine_types::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
