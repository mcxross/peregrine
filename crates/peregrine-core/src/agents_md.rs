...
use peregrine_config::default_project_root_markers;
use peregrine_config::merge_toml_values;
use peregrine_config::project_root_markers_from_config;
use std::io;
...
impl<'a> AgentsMdManager<'a> {
    ...
    pub(crate) async fn load_global_instructions(
        ...
        peregrine_dir: Option<&AbsolutePathBuf>,
        startup_warnings: &mut Vec<String>,
    ) -> Option<LoadedAgentsMd> {
        let base = peregrine_dir?;
