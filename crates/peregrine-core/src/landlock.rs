...
/// (peregrine-linux-sandbox), which defaults to bubblewrap for filesystem
    ...
    P: AsRef<Path>,
{
    ...
    let peregrine_linux_sandbox_exe = codex_linux_sandbox_exe.as_ref();
    ...
    let arg0 = if peregrine_linux_sandbox_exe
        .file_name()
        ...
        == Some(CODEX_LINUX_SANDBOX_ARG0)
    {
        ...
        peregrine_linux_sandbox_exe.to_string_lossy().into_owned()
    } else {
        CODEX_LINUX_SANDBOX_ARG0.to_string()
    };
    spawn_child_async(SpawnChildRequest {
        program: peregrine_linux_sandbox_exe.to_path_buf(),
        args,
        arg0: Some(&arg0),
        cwd: command_cwd,
