...
pub struct TurnContext {
    ...
    pub(crate) peregrine_self_exe: Option<PathBuf>,
    pub(crate) peregrine_linux_sandbox_exe: Option<PathBuf>,
...
impl TurnContext {
    ...
    pub(crate) async fn with_model(
        ...
        Self {
            ...
            peregrine_self_exe: self.peregrine_self_exe.clone(),
            peregrine_linux_sandbox_exe: self.peregrine_linux_sandbox_exe.clone(),
            truncation_policy,
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        TurnContext {
            ...
            peregrine_self_exe: per_turn_config.peregrine_self_exe.clone(),
            peregrine_linux_sandbox_exe: per_turn_config.peregrine_linux_sandbox_exe.clone(),
    ...
    pub(crate) async fn new_turn_with_sub_id(
    ...
    ) -> PeregrineResult<Arc<TurnContext>> {
        let notify_config_contributors = !self.services.extensions.config_contributors().is_empty();
        let update_result: PeregrineResult<_> = {
            ...
            match state.session_configuration.clone().apply(&updates) {
                Ok(next) => {
                    ...
                    let peregrine_home = next.peregrine_home.clone();
                ...
                Err(err) => Err(PeregrineErr::InvalidRequest(err.to_string())),
            }
        };
        ...
        let (
            ...
            Err(err) => {
                ...
                .await;
                return Err(PeregrineErr::InvalidRequest(message));
            }
        };
    ...
    ) -> PeregrineResult<ResolvedTurnEnvironments> {
    ...
    async fn new_turn_from_configuration(
        ...
        let per_turn_config = Self::build_per_turn_config(&session_configuration, cwd.clone());
        {
            let mcp_connection_manager =
                Box::pin(self.services.mcp_connection_manager.read()).await;
            mcp_connection_manager.set_approval_policy(&crate::config::codex_approval_policy(
        ...
        let model_info = Box::pin(self.services.models_manager.get_model_info(
            session_configuration.collaboration_mode.model(),
            &models_manager_config,
        ))
        .await;
        let plugins_config_input = per_turn_config.plugins_config_input();
        ...
        turn_context.realtime_active = Box::pin(self.conversation.running_state()).await.is_some();
    ...
    pub(crate) async fn new_default_turn(&self) -> Arc<TurnContext> {
        Box::pin(self.new_default_turn_with_sub_id(self.next_internal_sub_id())).await
    }
