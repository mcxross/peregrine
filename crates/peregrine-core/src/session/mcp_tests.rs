...
fn guardian_meta(tool_params: Option<Value>) -> Option<Meta> {
    let mut value = json!({
        "peregrine_approval_kind": "mcp_tool_call",
        "peregrine_request_type": "approval_request",
...
fn plugin_install_elicitation_telemetry_metadata_requires_install_tool_suggestion() {
    let event = EventMsg::ElicitationRequest(ElicitationRequestEvent {
        ...
        id: peregrine_types::mcp::RequestId::String("request-1".to_string()),
        request: peregrine_types::approvals::ElicitationRequest::Form {
            meta: Some(json!({
                "peregrine_approval_kind": "tool_suggestion",
    ...
    let enable_event = EventMsg::ElicitationRequest(ElicitationRequestEvent {
        turn_id: Some("turn-1".to_string()),
        server_name: "peregrine_apps".to_string(),
        id: peregrine_types::mcp::RequestId::String("request-2".to_string()),
        request: peregrine_types::approvals::ElicitationRequest::Form {
            meta: Some(json!({
                "peregrine_approval_kind": "tool_suggestion",
                "suggest_type": "enable",
