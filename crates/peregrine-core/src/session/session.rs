...
pub(crate) struct SessionConfiguration {
    ...
    /// Directory containing all Peregrine state for this session.
    pub(super) peregrine_home: AbsolutePathBuf,
...
impl SessionConfiguration {
    pub(crate) fn peregrine_home(&self) -> &AbsolutePathBuf {
        &self.peregrine_home
    }
            ...
            if let Some(active_permission_profile) = next_configuration.active_permission_profile()
            {
                ...
                config.permissions.network = config
                    ...
                    .map_err(|err| ConstraintError::InvalidValue {
                        ...
                        requirement_source: peregrine_config::RequirementSource::Unknown,
                    })?;
                config
                    .permissions
    ...
    pub(crate) async fn new(
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let trace_agent_path = session_configuration
                .session_source
                .get_agent_path()
                .unwrap_or_else(peregrine_types::AgentPath::root);
            let trace_task_name =
            ...
            let config_path = config.peregrine_home.join(CONFIG_TOML_FILE);
            ...
            let auth_mode = auth.map(|auth| {
                if matches!(auth, CodexAuth::ApiKey(_)) {
            ...
            let services = SessionServices {
                ...
                mcp_connection_manager: Arc::new(RwLock::new(
                    McpConnectionManager::new_uninitialized_with_permission_profile(
                        &crate::config::codex_approval_policy(
            ...
            .map_err(|err| {
                PeregrineErr::InvalidRequest(err.to_string().replace(
            ...
            let (mcp_connection_manager, cancel_token) = McpConnectionManager::new(
                ...
                auth_statuses.clone(),
                &crate::config::codex_approval_policy(&session_configuration.approval_policy),
