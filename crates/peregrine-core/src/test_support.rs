...
use peregrine_models_manager::collaboration_mode_presets;
...
pub fn auth_manager_from_auth_with_home(
    ...
    AuthManager::from_auth_for_testing_with_home(auth, peregrine_home)
}
...
) -> peregrine_types::error::Result<crate::NewThread> {
    thread_manager
...
pub fn models_manager_with_provider(
    ...
    provider.models_manager(peregrine_home, /*config_model_catalog*/ None)
}
