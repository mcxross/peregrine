...
/// `codex_feedback::PeregrineFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// ```rust
/// peregrine_core::feedback_tags!(model = "gpt-5", cached = true);
/// let provider_id = "openai";
/// let request_id = "req_123";
/// peregrine_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
