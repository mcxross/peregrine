...
use peregrine_types::protocol::HookCompletedEvent;
use peregrine_types::protocol::HookEventName;
use peregrine_types::protocol::HookRunStatus;
use peregrine_types::protocol::HookRunSummary;
use peregrine_types::protocol::HookSource;
use peregrine_types::protocol::HookStartedEvent;
...
pub(crate) async fn run_legacy_after_agent_hook(
    ...
    let event = EventMsg::Error(peregrine_types::protocol::ErrorEvent {
        message,
...
mod tests {
    ...
    use peregrine_types::protocol::HookEventName;
    use peregrine_types::protocol::HookExecutionMode;
    use peregrine_types::protocol::HookHandlerType;
    use peregrine_types::protocol::HookRunStatus;
    use peregrine_types::protocol::HookScope;
    use peregrine_types::protocol::HookSource;
        ...
        assert_eq!(
            messages
                ...
                .map(|message| match message {
                    peregrine_types::models::ResponseItem::Message { role, content, .. } => {
                        let text = content
                            .iter()
                            .map(|item| match item {
