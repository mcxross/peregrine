...
use peregrine_types::protocol::PatchApplyUpdatedEvent;
...
fn write_permissions_for_paths(
    ...
    file_system_sandbox_policy: &peregrine_types::permissions::FileSystemSandboxPolicy,
    cwd: &AbsolutePathBuf,
...
async fn effective_patch_permissions(
    ...
    peregrine_types::permissions::FileSystemSandboxPolicy,
) {
