...
use peregrine_types::protocol::NetworkPolicyRuleAction;
...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            codex_linux_sandbox_exe: turn_ctx.peregrine_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
        ...
        match first_result {
            ...
            Err(ToolError::Peregrine(PeregrineErr::Sandbox(SandboxErr::Denied {
                ...
                if network_policy_decision.is_some() && network_approval_context.is_none() {
                    return Err(ToolError::Peregrine(PeregrineErr::Sandbox(
                        SandboxErr::Denied {
                            output,
                            network_policy_decision,
                        },
                ...
                let retry_peregrine_linux_sandbox_exe = if unsandboxed_allowed {
                    None
                } else {
                    turn_ctx.peregrine_linux_sandbox_exe.as_ref()
                };
                let retry_attempt = SandboxAttempt {
                    ...
                    sandbox_cwd,
                    workspace_roots: workspace_roots.as_slice(),
                    codex_linux_sandbox_exe: retry_peregrine_linux_sandbox_exe,
                    use_legacy_landlock,
                    windows_sandbox_level: turn_ctx.windows_sandbox_level,
                    windows_sandbox_private_desktop: turn_ctx
                        .config
