...
fn network_approval_error_message(err: ToolError) -> String {
    match err {
        ...
        ToolError::Peregrine(err) => err.to_string(),
    }
}
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        if request.sandbox == codex_sandboxing::SandboxType::WindowsRestrictedToken {
            let peregrine_home = crate::config::find_peregrine_home().map_err(|err| {
            ...
            let spawned = match request.windows_sandbox_level {
                ...
                peregrine_types::config_types::WindowsSandboxLevel::RestrictedToken
    ...
    pub(super) async fn open_session_with_sandbox(
        ...
        orchestrator
            ...
            .map_err(|err| match err {
                ToolError::Peregrine(PeregrineErr::Sandbox(SandboxErr::Denied {
                    output, ..
                })) => {
                    let output = *output;
