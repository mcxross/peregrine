...
use peregrine_types::protocol::GuardianAssessmentAction;
use peregrine_types::protocol::GuardianAssessmentStatus;
use peregrine_types::protocol::GuardianCommandSource;
...
use peregrine_types::request_user_input::RequestUserInputEvent;
...
async fn forward_ops_preserves_submission_trace_context() {
    ...
    let submission = Submission {
        ...
        trace: Some(peregrine_types::protocol::W3cTraceContext {
            traceparent: Some(
...
#[tokio::test]
async fn run_peregrine_thread_interactive_respects_pre_cancelled_spawn() {
    ...
    let result = timeout(
        ...
        run_peregrine_thread_interactive(
    ...
    assert!(matches!(result, Err(PeregrineErr::TurnAborted)));
}
