...
fn sandbox_detection_ignores_network_policy_text_in_non_sandbox_mode() {
    let output = make_exec_output(
        ...
        "",
        "",
        r#"PEREGRINE_NETWORK_POLICY_DECISION {"decision":"ask","reason":"not_allowed","source":"decider","protocol":"http","host":"google.com","port":80}"#,
    );
    assert!(!is_likely_sandbox_denied(SandboxType::None, &output));
}
...
fn sandbox_detection_ignores_network_policy_text_with_zero_exit_code() {
    let output = make_exec_output(
        ...
        "",
        "",
        r#"PEREGRINE_NETWORK_POLICY_DECISION {"decision":"ask","source":"decider","protocol":"http","host":"google.com","port":80}"#,
    );
...
fn windows_elevated_allows_split_restricted_read_policies() {
    ...
    let file_system_policy = FileSystemSandboxPolicy::restricted(vec![
        peregrine_types::permissions::FileSystemSandboxEntry {
            path: peregrine_types::permissions::FileSystemPath::Path { path: docs },
            access: peregrine_types::permissions::FileSystemAccessMode::Read,
        },
    ]);
...
fn windows_restricted_token_rejects_split_only_filesystem_policies() {
    ...
    let file_system_policy = FileSystemSandboxPolicy::restricted(vec![
        peregrine_types::permissions::FileSystemSandboxEntry {
            path: peregrine_types::permissions::FileSystemPath::Special {
                value: peregrine_types::permissions::FileSystemSpecialPath::project_roots(
                    /*subpath*/ None,
                ),
            },
            access: peregrine_types::permissions::FileSystemAccessMode::Write,
        },
        peregrine_types::permissions::FileSystemSandboxEntry {
            path: peregrine_types::permissions::FileSystemPath::Path {
...
fn windows_restricted_token_supports_full_read_split_write_read_carveouts() {
    ...
    let file_system_policy = FileSystemSandboxPolicy::restricted(vec![
        ...
        peregrine_types::permissions::FileSystemSandboxEntry {
            path: peregrine_types::permissions::FileSystemPath::Path { path: docs.clone() },
            access: peregrine_types::permissions::FileSystemAccessMode::Read,
        },
    ]);

    // The legacy workspace-write root already protects top-level `.peregrine`, so
...
fn windows_restricted_token_rejects_unreadable_split_carveouts() {
    ...
    let file_system_policy = FileSystemSandboxPolicy::restricted(vec![
        ...
        peregrine_types::permissions::FileSystemSandboxEntry {
            path: peregrine_types::permissions::FileSystemPath::Path { path: blocked },
...
fn process_exec_tool_call_uses_platform_sandbox_for_network_only_restrictions() {
    ...
    assert_eq!(
        select_process_exec_tool_sandbox_type(
            ...
            NetworkSandboxPolicy::Restricted,
            peregrine_types::config_types::WindowsSandboxLevel::Disabled,
...
async fn kill_child_process_group_kills_grandchildren_on_timeout() -> Result<()> {
    ...
    let params = ExecParams {
        ...
        network: None,
        sandbox_permissions: SandboxPermissions::UseDefault,
        windows_sandbox_level: peregrine_types::config_types::WindowsSandboxLevel::Disabled,
        windows_sandbox_private_desktop: false,
        justification: None,
        arg0: None,
    };
