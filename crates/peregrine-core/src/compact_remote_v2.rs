...
use peregrine_types::protocol::TruncationPolicy;
...
) -> PeregrineResult<(ResponseItem, String)> {
...
mod tests {
    ...
    fn response_stream(events: Vec<PeregrineResult<ResponseEvent>>) -> ResponseStream {
