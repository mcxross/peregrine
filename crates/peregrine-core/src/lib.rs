...
mod config_lock;
mod peregrine_thread;
pub use peregrine_thread::PeregrineThread;
pub use peregrine_thread::PeregrineThreadSettingsOverrides;
...
pub use peregrine_types::config_types::ModelProviderAuthInfo;
mod event_mapping;
...
#[deprecated(note = "use PeregrineThread")]
pub type PeregrineConversation = PeregrineThread;
...
pub use client::X_PEREGRINE_INSTALLATION_ID_HEADER;
pub use client::X_PEREGRINE_TURN_METADATA_HEADER;
