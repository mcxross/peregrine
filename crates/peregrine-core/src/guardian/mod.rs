...
use peregrine_types::protocol::GuardianAssessmentOutcome;
...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: peregrine_types::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: peregrine_types::protocol::GuardianUserAuthorization,
