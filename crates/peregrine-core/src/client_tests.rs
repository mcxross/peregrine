...
use super::X_PEREGRINE_INSTALLATION_ID_HEADER;
use super::X_PEREGRINE_PARENT_THREAD_ID_HEADER;
use super::X_PEREGRINE_TURN_METADATA_HEADER;
use super::X_PEREGRINE_WINDOW_ID_HEADER;
use crate::AttestationContext;
use crate::AttestationProvider;
use crate::GenerateAttestationFuture;
use codex_login::AuthManager;
use codex_login::CodexAuth;
use codex_model_provider_info::CHATGPT_CODEX_BASE_URL as CHATGPT_PEREGRINE_BASE_URL;
...
fn model_client_with_counting_attestation(
    ...
    let (auth_manager, provider) = if include_attestation {
        (
            ...
            ModelProviderInfo::create_openai_provider(Some(CHATGPT_PEREGRINE_BASE_URL.to_string())),
        )
    } else {
        (
            None,
...
#[tokio::test]
async fn websocket_handshake_includes_attestation_for_chatgpt_peregrine_responses() {
...
#[tokio::test]
async fn non_chatgpt_peregrine_endpoints_omit_attestation_generation() {
    let (model_client, attestation_calls) =
