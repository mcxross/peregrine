use crate::security::SecurityCommand;
use peregrine_mcp_protocol::{CommandResult, CommandStatus, MAX_OUTPUT_BYTES, PackageSummary};
...
mod tests {
    use super::*;
    #[cfg(unix)]
    use crate::security::SecurityCommandExecution;
    #[cfg(unix)]
    use peregrine_mcp_protocol::CommandStatus;
    #[cfg(unix)]
