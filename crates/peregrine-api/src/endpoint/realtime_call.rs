...
use peregrine_client::RequestTelemetry;
use serde::Serialize;
...
const MULTIPART_BOUNDARY: &str = "peregrine-realtime-call-boundary";
const MULTIPART_CONTENT_TYPE: &str =
    "multipart/form-data; boundary=peregrine-realtime-call-boundary";
...
impl<T: HttpTransport> RealtimeCallClient<T> {
    ...
    pub async fn create_with_session_and_headers(
        ...
        trace!(target: "peregrine_api::realtime_websocket::wire", "realtime call request SDP: {sdp}");
