...
use peregrine_sui_move_insights::report::{
...
mod tests {
    use super::*;
    use peregrine_sui_move_insights::attack_surface::package_surface;
    use peregrine_sui_move_model::parse_module_declarations;
    use std::fs;
