...
pub use harness::{
    ...
    AuditReport, AuditRun, AuditRunStatus, AuditStageId, AuditStagePlan, AuditStageRun,
    AuditStageStatus, AuditTarget, AuditWorkItem, AuditWorkItemStatus, CodeLocation,
    EvidenceConfidence, EvidenceItem, EvidenceKind, ExploitBundle, ExploitIntent,
    FindingCandidate, FindingCandidateSeverity, FindingCandidateStatus, JsonSchema, Metadata,
    PatchRecommendation, SecurityTool,
