use super::{
    MoveFunctionSignature, MoveModule, MoveStructSignature, ObjectLifecycleFunctionRef,
    ObjectLifecycleMap, ObjectLifecycleRisk, ObjectLifecycleStage,
};
...
pub(crate) fn object_lifecycle_maps(
    modules: &[MoveModule],
