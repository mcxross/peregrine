...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::analyzers::list_analyzer_plugins,
            commands::analyzers::install_analyzer_plugin,
            commands::analyzers::remove_analyzer_plugin,
            commands::analyzers::set_analyzer_plugin_enabled,
            commands::analyzers::list_analyzer_rule_catalog,
            commands::analyzers::save_analysis_rule_config,
            ...
            commands::sui::set_active_sui_network_env,
            commands::sui::remove_sui_network_env,
            ...
            commands::agent_server::agent_server_model_provider_select,
            commands::agent_server::agent_server_thread_list,
            commands::agent_server::agent_server_thread_read,
