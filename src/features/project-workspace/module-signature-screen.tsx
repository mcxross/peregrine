...
export function ModuleSignatureScreen({
  ...
  return (
    <section className="grid h-full min-h-0 grid-rows-[auto_minmax(0,1fr)] bg-[var(--app-window)]">
      <header className="flex min-w-0 items-start justify-between gap-4 border-b border-[color:var(--app-border)] px-6 py-4">
        <div className="min-w-0">
          <h2 className="truncate text-2xl font-semibold">{moveModule.name}</h2>
